...
`)}const Jd={[Bo]:"Linear",[zo]:"Reinhard",[Go]:"Cineon",[Vo]:"ACESFilmic",[ko]:"AgX",[Wo]:"Neutral",[Ho]:"Custom"};function Qd(i,e){const t=Jd[e];return t===void 0?(Pe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ar=new F;function ep(){qe.getLuminanceCoefficients(ar);const i=ar.x.toFixed(4),e=ar.y.toFixed(4),t=ar.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+h);const y=M+f+a,T=M+h+o,D=Ao(r,r.VERTEX_SHADER,y),b=Ao(r,r.FRAGMENT_SHADER,T);r.attachShader(E,D),r.attachShader(E,b),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function P(w){if(i.debug.checkShaderErrors){const O=r.getProgramInfoLog(E)||"",q=r.getShaderInfoLog(D)||"",W=r.getShaderInfoLog(b)||"",I=O.trim(),G=q.trim(),V=W.trim();let J=!0,ne=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,E,D,b);else{const ce=wo(r,D,"vertex"),ve=wo(r,b,"fragment");je("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`,Np=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],Fp=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],Fo=new ct,Si=new F,os=new F;function Op(i,e,t){let n=new da;const r=new Ke,s=new Ke,a=new ht,o=new qc,c=new Yc,l={},d=t.maxTextureSize,m={[Rn]:Dt,[Dt]:Rn,[un]:un},u=new qt({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ke},radius:{value:4}},vertexShader:Up,fragmentShader:Ip}),g=u.clone();g.defines.HORIZONTAL_PASS=1;const v=new wt;v.setAttribute("position",new Pt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new Xt(v,u),f=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=or;let h=this.type;this.render=function(b,P,_){if(f.enabled===!1||f.autoUpdate===!1&&f.needsUpdate===!1||b.length===0)return;this.type===Ll&&(Pe("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=or);const A=i.getRenderTarget(),L=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),O=i.state;O.setBlending(fn),O.buffers.depth.getReversed()===!0?O.buffers.color.setClear(0,0,0,0):O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);const q=h!==this.type;q&&P.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(I=>I.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,I=b.length;W<I;W++){const G=b[W],V=G.shadow;if(V===void 0){Pe("WebGLShadowMap:",G,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const J=V.getFrameExtents();r.multiply(J),s.copy(V.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/J.x),r.x=s.x*J.x,V.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/J.y),r.y=s.y*J.y,V.mapSize.y=s.y));const ne=i.state.buffers.depth.getReversed();if(V.camera._reversedDepth=ne,V.map===null||q===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Ei){if(G.isPointLight){Pe("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new tn(r.x,r.y,{format:zn,type:pn,minFilter:Tt,magFilter:Tt,generateMipmaps:!1}),V.map.texture.name=G.name+".shadowMap",V.map.depthTexture=new li(r.x,r.y,Jt),V.map.depthTexture.name=G.name+".shadowMapDepth",V.map.depthTexture.format=mn,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=vt,V.map.depthTexture.magFilter=vt}else G.isPointLight?(V.map=new ml(r.x),V.map.depthTexture=new Gc(r.x,nn)):(V.map=new tn(r.x,r.y),V.map.depthTexture=new li(r.x,r.y,nn)),V.map.depthTexture.name=G.name+".shadowMap",V.map.depthTexture.format=mn,this.type===or?(V.map.depthTexture.compareFunction=ne?la:oa,V.map.depthTexture.minFilter=Tt,V.map.depthTexture.magFilter=Tt):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=vt,V.map.depthTexture.magFilter=vt);V.camera.updateProjectionMatrix()}const ce=V.map.isWebGLCubeRenderTarget?6:1;for(let ve=0;ve<ce;ve++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,ve),i.clear();else{ve===0&&(i.setRenderTarget(V.map),i.clear());const Ee=V.getViewport(ve);a.set(s.x*Ee.x,s.y*Ee.y,s.x*Ee.z,s.y*Ee.w),O.viewport(a)}if(G.isPointLight){const Ee=V.camera,We=V.matrix,Qe=G.distance||Ee.far;Qe!==Ee.far&&(Ee.far=Qe,Ee.updateProjectionMatrix()),Si.setFromMatrixPosition(G.matrixWorld),Ee.position.copy(Si),os.copy(Ee.position),os.add(Np[ve]),Ee.up.copy(Fp[ve]),Ee.lookAt(os),Ee.updateMatrixWorld(),We.makeTranslation(-Si.x,-Si.y,-Si.z),Fo.multiplyMatrices(Ee.projectionMatrix,Ee.matrixWorldInverse),V._frustum.setFromProjectionMatrix(Fo,Ee.coordinateSystem,Ee.reversedDepth)}else V.updateMatrices(G);n=V.getFrustum(),T(P,_,V.camera,G,this.type)}V.isPointLightShadow!==!0&&this.type===Ei&&M(V,_),V.needsUpdate=!1}h=this.type,f.needsUpdate=!1,i.setRenderTarget(A,L,w)};function M(b,P){const _=e.update(E);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,g.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,g.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new tn(r.x,r.y,{format:zn,type:pn})),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(P,null,_,u,E,null),g.uniforms.shadow_pass.value=b.mapPass.texture,g.uniforms.resolution.value=b.mapSize,g.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(P,null,_,g,E,null)}function y(b,P,_,A){let L=null;const w=_.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(w!==void 0)L=w;else if(L=_.isPointLight===!0?c:o,i.localClippingEnabled&&P.clipShadows===!0&&Array.isArray(P.clippingPlanes)&&P.clippingPlanes.length!==0||P.displacementMap&&P.displacementScale!==0||P.alphaMap&&P.alphaTest>0||P.map&&P.alphaTest>0||P.alphaToCoverage===!0){const O=L.uuid,q=P.uuid;let W=l[O];W===void 0&&(W={},l[O]=W);let I=W[q];I===void 0&&(I=L.clone(),W[q]=I,P.addEventListener("dispose",D)),L=I}if(L.visible=P.visible,L.wireframe=P.wireframe,A===Ei?L.side=P.shadowSide!==null?P.shadowSide:P.side:L.side=P.shadowSide!==null?P.shadowSide:m[P.side],L.alphaMap=P.alphaMap,L.alphaTest=P.alphaToCoverage===!0?.5:P.alphaTest,L.map=P.map,L.clipShadows=P.clipShadows,L.clippingPlanes=P.clippingPlanes,L.clipIntersection=P.clipIntersection,L.displacementMap=P.displacementMap,L.displacementScale=P.displacementScale,L.displacementBias=P.displacementBias,L.wireframeLinewidth=P.wireframeLinewidth,L.linewidth=P.linewidth,_.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const O=i.properties.get(L);O.light=_}return L}function T(b,P,_,A,L){if(b.visible===!1)return;if(b.layers.test(P.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&L===Ei)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,b.matrixWorld);const q=e.update(b),W=b.material;if(Array.isArray(W)){const I=q.groups;for(let G=0,V=I.length;G<V;G++){const J=I[G],ne=W[J.materialIndex];if(ne&&ne.visible){const ce=y(b,ne,A,L);b.onBeforeShadow(i,b,P,_,q,ce,J),i.renderBufferDirect(_,null,q,ce,b,J),b.onAfterShadow(i,b,P,_,q,ce,J)}}}else if(W.visible){const I=y(b,W,A,L);b.onBeforeShadow(i,b,P,_,q,I,null),i.renderBufferDirect(_,null,q,I,b,null),b.onAfterShadow(i,b,P,_,q,I,null)}}const O=b.children;for(let q=0,W=O.length;q<W;q++)T(O[q],P,_,A,L)}function D(b){b.target.removeEventListener("dispose",D);for(const _ in l){const A=l[_],L=b.target.uuid;L in A&&(A[L].dispose(),delete A[L])}}}function Bp(i,e){function t(){let C=!1;const ae=new ht;let Y=null;const ge=new ht(0,0,0,0);return{setMask:function(le){Y!==le&&!C&&(i.colorMask(le,le,le,le),Y=le)},setLocked:function(le){C=le},setClear:function(le,j,ye,Oe,ft){ft===!0&&(le*=Oe,j*=Oe,ye*=Oe),ae.set(le,j,ye,Oe),ge.equals(ae)===!1&&(i.clearColor(le,j,ye,Oe),ge.copy(ae))},reset:function(){C=!1,Y=null,ge.set(-1,0,0,0)}}}function n(){let C=!1,ae=!1,Y=null,ge=null,le=null;return{setReversed:function(j){if(ae!==j){const ye=e.get("EXT_clip_control");j?ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.ZERO_TO_ONE_EXT):ye.clipControlEXT(ye.LOWER_LEFT_EXT,ye.NEGATIVE_ONE_TO_ONE_EXT),ae=j;const Oe=le;le=null,this.setClear(Oe)}},getReversed:function(){return ae},setTest:function(j){j?se(i.DEPTH_TEST):we(i.DEPTH_TEST)},setMask:function(j){Y!==j&&!C&&(i.depthMask(j),Y=j)},setFunc:function(j){if(ae&&(j=hc[j]),ge!==j){switch(j){case us:i.depthFunc(i.NEVER);break;case hs:i.depthFunc(i.ALWAYS);break;case fs:i.depthFunc(i.LESS);break;case ai:i.depthFunc(i.LEQUAL);break;case ds:i.depthFunc(i.EQUAL);break;case ps:i.depthFunc(i.GEQUAL);break;case ms:i.depthFunc(i.GREATER);break;case gs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ge=j}},setLocked:function(j){C=j},setClear:function(j){le!==j&&(le=j,ae&&(j=1-j),i.clearDepth(j))},reset:function(){C=!1,Y=null,ge=null,le=null,ae=!1}}}function r(){let C=!1,ae=null,Y=null,ge=null,le=null,j=null,ye=null,Oe=null,ft=null;return{setTest:function(it){C||(it?se(i.STENCIL_TEST):we(i.STENCIL_TEST))},setMask:function(it){ae!==it&&!C&&(i.stencilMask(it),ae=it)},setFunc:function(it,rn,Yt){(Y!==it||ge!==rn||le!==Yt)&&(i.stencilFunc(it,rn,Yt),Y=it,ge=rn,le=Yt)},setOp:function(it,rn,Yt){(j!==it||ye!==rn||Oe!==Yt)&&(i.stencilOp(it,rn,Yt),j=it,ye=rn,Oe=Yt)},setLocked:function(it){C=it},setClear:function(it){ft!==it&&(i.clearStencil(it),ft=it)},reset:function(){C=!1,ae=null,Y=null,ge=null,le=null,j=null,ye=null,Oe=null,ft=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let d={},m={},u={},g=new WeakMap,v=[],E=null,f=!1,h=null,M=null,y=null,T=null,D=null,b=null,P=null,_=new Ve(0,0,0),A=0,L=!1,w=null,O=null,q=null,W=null,I=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,J=0;const ne=i.getParameter(i.VERSION);ne.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(ne)[1]),V=J>=1):ne.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(ne)[1]),V=J>=2);let ce=null,ve={};const Ee=i.getParameter(i.SCISSOR_BOX),We=i.getParameter(i.VIEWPORT),Qe=new ht().fromArray(Ee),Ne=new ht().fromArray(We);function Z(C,ae,Y,ge){const le=new Uint8Array(4),j=i.createTexture();i.bindTexture(C,j),i.texParameteri(C,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(C,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ye=0;ye<Y;ye++)C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY?i.texImage3D(ae,0,i.RGBA,1,1,ge,0,i.RGBA,i.UNSIGNED_BYTE,le):i.texImage2D(ae+ye,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,le);return j}const he={};he[i.TEXTURE_2D]=Z(i.TEXTURE_2D,i.TEXTURE_2D,1),he[i.TEXTURE_CUBE_MAP]=Z(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),he[i.TEXTURE_2D_ARRAY]=Z(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),he[i.TEXTURE_3D]=Z(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),se(i.DEPTH_TEST),a.setFunc(ai),Me(!1),Ue(Pa),se(i.CULL_FACE),nt(fn);function se(C){d[C]!==!0&&(i.enable(C),d[C]=!0)}function we(C){d[C]!==!1&&(i.disable(C),d[C]=!1)}function Le(C,ae){return u[C]!==ae?(i.bindFramebuffer(C,ae),u[C]=ae,C===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ae),C===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ae),!0):!1}function Ce(C,ae){let Y=v,ge=!1;if(C){Y=g.get(ae),Y===void 0&&(Y=[],g.set(ae,Y));const le=C.textures;if(Y.length!==le.length||Y[0]!==i.COLOR_ATTACHMENT0){for(let j=0,ye=le.length;j<ye;j++)Y[j]=i.COLOR_ATTACHMENT0+j;Y.length=le.length,ge=!0}}else Y[0]!==i.BACK&&(Y[0]=i.BACK,ge=!0);ge&&i.drawBuffers(Y)}function ot(C){return E!==C?(i.useProgram(C),E=C,!0):!1}const He={[In]:i.FUNC_ADD,[Il]:i.FUNC_SUBTRACT,[Nl]:i.FUNC_REVERSE_SUBTRACT};He[Fl]=i.MIN,He[Ol]=i.MAX;const et={[Bl]:i.ZERO,[zl]:i.ONE,[Gl]:i.SRC_COLOR,[ls]:i.SRC_ALPHA,[ql]:i.SRC_ALPHA_SATURATE,[Wl]:i.DST_COLOR,[Hl]:i.DST_ALPHA,[Vl]:i.ONE_MINUS_SRC_COLOR,[cs]:i.ONE_MINUS_SRC_ALPHA,[Xl]:i.ONE_MINUS_DST_COLOR,[kl]:i.ONE_MINUS_DST_ALPHA,[Yl]:i.CONSTANT_COLOR,[Kl]:i.ONE_MINUS_CONSTANT_COLOR,[Zl]:i.CONSTANT_ALPHA,[$l]:i.ONE_MINUS_CONSTANT_ALPHA};function nt(C,ae,Y,ge,le,j,ye,Oe,ft,it){if(C===fn){f===!0&&(we(i.BLEND),f=!1);return}if(f===!1&&(se(i.BLEND),f=!0),C!==Ul){if(C!==h||it!==L){if((M!==In||D!==In)&&(i.blendEquation(i.FUNC_ADD),M=In,D=In),it)switch(C){case ri:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dr:i.blendFunc(i.ONE,i.ONE);break;case Da:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case La:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:je("WebGLState: Invalid blending: ",C);break}else switch(C){case ri:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case dr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Da:je("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case La:je("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:je("WebGLState: Invalid blending: ",C);break}y=null,T=null,b=null,P=null,_.set(0,0,0),A=0,h=C,L=it}return}le=le||ae,j=j||Y,ye=ye||ge,(ae!==M||le!==D)&&(i.blendEquationSeparate(He[ae],He[le]),M=ae,D=le),(Y!==y||ge!==T||j!==b||ye!==P)&&(i.blendFuncSeparate(et[Y],et[ge],et[j],et[ye]),y=Y,T=ge,b=j,P=ye),(Oe.equals(_)===!1||ft!==A)&&(i.blendColor(Oe.r,Oe.g,Oe.b,ft),_.copy(Oe),A=ft),h=C,L=!1}function ze(C,ae){C.side===un?we(i.CULL_FACE):se(i.CULL_FACE);let Y=C.side===Dt;ae&&(Y=!Y),Me(Y),C.blending===ri&&C.transparent===!1?nt(fn):nt(C.blending,C.blendEquation,C.blendSrc,C.blendDst,C.blendEquationAlpha,C.blendSrcAlpha,C.blendDstAlpha,C.blendColor,C.blendAlpha,C.premultipliedAlpha),a.setFunc(C.depthFunc),a.setTest(C.depthTest),a.setMask(C.depthWrite),s.setMask(C.colorWrite);const ge=C.stencilWrite;o.setTest(ge),ge&&(o.setMask(C.stencilWriteMask),o.setFunc(C.stencilFunc,C.stencilRef,C.stencilFuncMask),o.setOp(C.stencilFail,C.stencilZFail,C.stencilZPass)),R(C.polygonOffset,C.polygonOffsetFactor,C.polygonOffsetUnits),C.alphaToCoverage===!0?se(i.SAMPLE_ALPHA_TO_COVERAGE):we(i.SAMPLE_ALPHA_TO_COVERAGE)}function Me(C){w!==C&&(C?i.frontFace(i.CW):i.frontFace(i.CCW),w=C)}function Ue(C){C!==Pl?(se(i.CULL_FACE),C!==O&&(C===Pa?i.cullFace(i.BACK):C===Dl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):we(i.CULL_FACE),O=C}function Re(C){C!==q&&(V&&i.lineWidth(C),q=C)}function R(C,ae,Y){C?(se(i.POLYGON_OFFSET_FILL),(W!==ae||I!==Y)&&(W=ae,I=Y,a.getReversed()&&(ae=-ae),i.polygonOffset(ae,Y))):we(i.POLYGON_OFFSET_FILL)}function Xe(C){C?se(i.SCISSOR_TEST):we(i.SCISSOR_TEST)}function Q(C){C===void 0&&(C=i.TEXTURE0+G-1),ce!==C&&(i.activeTexture(C),ce=C)}function be(C,ae,Y){Y===void 0&&(ce===null?Y=i.TEXTURE0+G-1:Y=ce);let ge=ve[Y];ge===void 0&&(ge={type:void 0,texture:void 0},ve[Y]=ge),(ge.type!==C||ge.texture!==ae)&&(ce!==Y&&(i.activeTexture(Y),ce=Y),i.bindTexture(C,ae||he[C]),ge.type=C,ge.texture=ae)}function ee(){const C=ve[ce];C!==void 0&&C.type!==void 0&&(i.bindTexture(C.type,null),C.type=void 0,C.texture=void 0)}function Ze(){try{i.compressedTexImage2D(...arguments)}catch(C){je("WebGLState:",C)}}function S(){try{i.compressedTexImage3D(...arguments)}catch(C){je("WebGLState:",C)}}function p(){try{i.texSubImage2D(...arguments)}catch(C){je("WebGLState:",C)}}function N(){try{i.texSubImage3D(...arguments)}catch(C){je("WebGLState:",C)}}function X(){try{i.compressedTexSubImage2D(...arguments)}catch(C){je("WebGLState:",C)}}function $(){try{i.compressedTexSubImage3D(...arguments)}catch(C){je("WebGLState:",C)}}function re(){try{i.texStorage2D(...arguments)}catch(C){je("WebGLState:",C)}}function oe(){try{i.texStorage3D(...arguments)}catch(C){je("WebGLState:",C)}}function k(){try{i.texImage2D(...arguments)}catch(C){je("WebGLState:",C)}}function K(){try{i.texImage3D(...arguments)}catch(C){je("WebGLState:",C)}}function ue(C){return m[C]!==void 0?m[C]:i.getParameter(C)}function me(C,ae){m[C]!==ae&&(i.pixelStorei(C,ae),m[C]=ae)}function ie(C){Qe.equals(C)===!1&&(i.scissor(C.x,C.y,C.z,C.w),Qe.copy(C))}function te(C){Ne.equals(C)===!1&&(i.viewport(C.x,C.y,C.z,C.w),Ne.copy(C))}function De(C,ae){let Y=l.get(ae);Y===void 0&&(Y=new WeakMap,l.set(ae,Y));let ge=Y.get(C);ge===void 0&&(ge=i.getUniformBlockIndex(ae,C.name),Y.set(C,ge))}function Ie(C,ae){const ge=l.get(ae).get(C);c.get(ae)!==ge&&(i.uniformBlockBinding(ae,ge,C.__bindingPointIndex),c.set(ae,ge))}function Je(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),d={},m={},ce=null,ve={},u={},g=new WeakMap,v=[],E=null,f=!1,h=null,M=null,y=null,T=null,D=null,b=null,P=null,_=new Ve(0,0,0),A=0,L=!1,w=null,O=null,q=null,W=null,I=null,Qe.set(0,0,i.canvas.width,i.canvas.height),Ne.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:se,disable:we,bindFramebuffer:Le,drawBuffers:Ce,useProgram:ot,setBlending:nt,setMaterial:ze,setFlipSided:Me,setCullFace:Ue,setLineWidth:Re,setPolygonOffset:R,setScissorTest:Xe,activeTexture:Q,bindTexture:be,unbindTexture:ee,compressedTexImage2D:Ze,compressedTexImage3D:S,texImage2D:k,texImage3D:K,pixelStorei:me,getParameter:ue,updateUBOMapping:De,uniformBlockBinding:Ie,texStorage2D:re,texStorage3D:oe,texSubImage2D:p,texSubImage3D:N,compressedTexSubImage2D:X,compressedTexSubImage3D:$,scissor:ie,viewport:te,reset:Je}}function zp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ke,d=new WeakMap,m=new Set;let u;const g=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(S,p){return v?new OffscreenCanvas(S,p):xr("canvas")}function f(S,p,N){let X=1;const $=Ze(S);if(($.width>N||$.height>N)&&(X=N/Math.max($.width,$.height)),X<1)if(typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&S instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&S instanceof ImageBitmap||typeof VideoFrame<"u"&&S instanceof VideoFrame){const re=Math.floor(X*$.width),oe=Math.floor(X*$.height);u===void 0&&(u=E(re,oe));const k=p?E(re,oe):u;return k.width=re,k.height=oe,k.getContext("2d").drawImage(S,0,0,re,oe),Pe("WebGLRenderer: Texture has been resized from ("+$.width+"x"+$.height+") to ("+re+"x"+oe+")."),k}else return"data"in S&&Pe("WebGLRenderer: Image in DataTexture is too big ("+$.width+"x"+$.height+")."),S;return S}function h(S){return S.generateMipmaps}function M(S){i.generateMipmap(S)}function y(S){return S.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:S.isWebGL3DRenderTarget?i.TEXTURE_3D:S.isWebGLArrayRenderTarget||S.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(S,p,N,X,$,re=!1){if(S!==null){if(i[S]!==void 0)return i[S];Pe("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+S+"'")}let oe;X&&(oe=e.get("EXT_texture_norm16"),oe||Pe("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let k=p;if(p===i.RED&&(N===i.FLOAT&&(k=i.R32F),N===i.HALF_FLOAT&&(k=i.R16F),N===i.UNSIGNED_BYTE&&(k=i.R8),N===i.UNSIGNED_SHORT&&oe&&(k=oe.R16_EXT),N===i.SHORT&&oe&&(k=oe.R16_SNORM_EXT)),p===i.RED_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.R8UI),N===i.UNSIGNED_SHORT&&(k=i.R16UI),N===i.UNSIGNED_INT&&(k=i.R32UI),N===i.BYTE&&(k=i.R8I),N===i.SHORT&&(k=i.R16I),N===i.INT&&(k=i.R32I)),p===i.RG&&(N===i.FLOAT&&(k=i.RG32F),N===i.HALF_FLOAT&&(k=i.RG16F),N===i.UNSIGNED_BYTE&&(k=i.RG8),N===i.UNSIGNED_SHORT&&oe&&(k=oe.RG16_EXT),N===i.SHORT&&oe&&(k=oe.RG16_SNORM_EXT)),p===i.RG_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.RG8UI),N===i.UNSIGNED_SHORT&&(k=i.RG16UI),N===i.UNSIGNED_INT&&(k=i.RG32UI),N===i.BYTE&&(k=i.RG8I),N===i.SHORT&&(k=i.RG16I),N===i.INT&&(k=i.RG32I)),p===i.RGB_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.RGB8UI),N===i.UNSIGNED_SHORT&&(k=i.RGB16UI),N===i.UNSIGNED_INT&&(k=i.RGB32UI),N===i.BYTE&&(k=i.RGB8I),N===i.SHORT&&(k=i.RGB16I),N===i.INT&&(k=i.RGB32I)),p===i.RGBA_INTEGER&&(N===i.UNSIGNED_BYTE&&(k=i.RGBA8UI),N===i.UNSIGNED_SHORT&&(k=i.RGBA16UI),N===i.UNSIGNED_INT&&(k=i.RGBA32UI),N===i.BYTE&&(k=i.RGBA8I),N===i.SHORT&&(k=i.RGBA16I),N===i.INT&&(k=i.RGBA32I)),p===i.RGB&&(N===i.UNSIGNED_SHORT&&oe&&(k=oe.RGB16_EXT),N===i.SHORT&&oe&&(k=oe.RGB16_SNORM_EXT),N===i.UNSIGNED_INT_5_9_9_9_REV&&(k=i.RGB9_E5),N===i.UNSIGNED_INT_10F_11F_11F_REV&&(k=i.R11F_G11F_B10F)),p===i.RGBA){const K=re?_r:qe.getTransfer($);N===i.FLOAT&&(k=i.RGBA32F),N===i.HALF_FLOAT&&(k=i.RGBA16F),N===i.UNSIGNED_BYTE&&(k=K===tt?i.SRGB8_ALPHA8:i.RGBA8),N===i.UNSIGNED_SHORT&&oe&&(k=oe.RGBA16_EXT),N===i.SHORT&&oe&&(k=oe.RGBA16_SNORM_EXT),N===i.UNSIGNED_SHORT_4_4_4_4&&(k=i.RGBA4),N===i.UNSIGNED_SHORT_5_5_5_1&&(k=i.RGB5_A1)}return(k===i.R16F||k===i.R32F||k===i.RG16F||k===i.RG32F||k===i.RGBA16F||k===i.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function D(S,p){let N;return S?p===null||p===nn||p===Ai?N=i.DEPTH24_STENCIL8:p===Jt?N=i.DEPTH32F_STENCIL8:p===bi&&(N=i.DEPTH24_STENCIL8,Pe("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):p===null||p===nn||p===Ai?N=i.DEPTH_COMPONENT24:p===Jt?N=i.DEPTH_COMPONENT32F:p===bi&&(N=i.DEPTH_COMPONENT16),N}function b(S,p){return h(S)===!0||S.isFramebufferTexture&&S.minFilter!==vt&&S.minFilter!==Tt?Math.log2(Math.max(p.width,p.height))+1:S.mipmaps!==void 0&&S.mipmaps.length>0?S.mipmaps.length:S.isCompressedTexture&&Array.isArray(S.image)?p.mipmaps.length:1}function P(S){const p=S.target;p.removeEventListener("dispose",P),A(p),p.isVideoTexture&&d.delete(p),p.isHTMLTexture&&m.delete(p)}function _(S){const p=S.target;p.removeEventListener("dispose",_),w(p)}function A(S){const p=n.get(S);if(p.__webglInit===void 0)return;const N=S.source,X=g.get(N);if(X){const $=X[p.__cacheKey];$.usedTimes--,$.usedTimes===0&&L(S),Object.keys(X).length===0&&g.delete(N)}n.remove(S)}function L(S){const p=n.get(S);i.deleteTexture(p.__webglTexture);const N=S.source,X=g.get(N);delete X[p.__cacheKey],a.memory.textures--}function w(S){const p=n.get(S);if(S.depthTexture&&(S.depthTexture.dispose(),n.remove(S.depthTexture)),S.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(p.__webglFramebuffer[X]))for(let $=0;$<p.__webglFramebuffer[X].length;$++)i.deleteFramebuffer(p.__webglFramebuffer[X][$]);else i.deleteFramebuffer(p.__webglFramebuffer[X]);p.__webglDepthbuffer&&i.deleteRenderbuffer(p.__webglDepthbuffer[X])}else{if(Array.isArray(p.__webglFramebuffer))for(let X=0;X<p.__webglFramebuffer.length;X++)i.deleteFramebuffer(p.__webglFramebuffer[X]);else i.deleteFramebuffer(p.__webglFramebuffer);if(p.__webglDepthbuffer&&i.deleteRenderbuffer(p.__webglDepthbuffer),p.__webglMultisampledFramebuffer&&i.deleteFramebuffer(p.__webglMultisampledFramebuffer),p.__webglColorRenderbuffer)for(let X=0;X<p.__webglColorRenderbuffer.length;X++)p.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(p.__webglColorRenderbuffer[X]);p.__webglDepthRenderbuffer&&i.deleteRenderbuffer(p.__webglDepthRenderbuffer)}const N=S.textures;for(let X=0,$=N.length;X<$;X++){const re=n.get(N[X]);re.__webglTexture&&(i.deleteTexture(re.__webglTexture),a.memory.textures--),n.remove(N[X])}n.remove(S)}let O=0;function q(){O=0}function W(){return O}function I(S){O=S}function G(){const S=O;return S>=r.maxTextures&&Pe("WebGLTextures: Trying to use "+S+" texture units while this GPU supports only "+r.maxTextures),O+=1,S}function V(S){const p=[];return p.push(S.wrapS),p.push(S.wrapT),p.push(S.wrapR||0),p.push(S.magFilter),p.push(S.minFilter),p.push(S.anisotropy),p.push(S.internalFormat),p.push(S.format),p.push(S.type),p.push(S.generateMipmaps),p.push(S.premultiplyAlpha),p.push(S.flipY),p.push(S.unpackAlignment),p.push(S.colorSpace),p.join()}function J(S,p){const N=n.get(S);if(S.isVideoTexture&&be(S),S.isRenderTargetTexture===!1&&S.isExternalTexture!==!0&&S.version>0&&N.__version!==S.version){const X=S.image;if(X===null)Pe("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Pe("WebGLRenderer: Texture marked for update but image is incomplete");else{we(N,S,p);return}}else S.isExternalTexture&&(N.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,N.__webglTexture,i.TEXTURE0+p)}function ne(S,p){const N=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&N.__version!==S.version){we(N,S,p);return}else S.isExternalTexture&&(N.__webglTexture=S.sourceTexture?S.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,N.__webglTexture,i.TEXTURE0+p)}function ce(S,p){const N=n.get(S);if(S.isRenderTargetTexture===!1&&S.version>0&&N.__version!==S.version){we(N,S,p);return}t.bindTexture(i.TEXTURE_3D,N.__webglTexture,i.TEXTURE0+p)}function ve(S,p){const N=n.get(S);if(S.isCubeDepthTexture!==!0&&S.version>0&&N.__version!==S.version){Le(N,S,p);return}t.bindTexture(i.TEXTURE_CUBE_MAP,N.__webglTexture,i.TEXTURE0+p)}const Ee={[_s]:i.REPEAT,[hn]:i.CLAMP_TO_EDGE,[xs]:i.MIRRORED_REPEAT},We={[vt]:i.NEAREST,[Ql]:i.NEAREST_MIPMAP_NEAREST,[Ni]:i.NEAREST_MIPMAP_LINEAR,[Tt]:i.LINEAR,[Cr]:i.LINEAR_MIPMAP_NEAREST,[Fn]:i.LINEAR_MIPMAP_LINEAR},Qe={[nc]:i.NEVER,[oc]:i.ALWAYS,[ic]:i.LESS,[oa]:i.LEQUAL,[rc]:i.EQUAL,[la]:i.GEQUAL,[sc]:i.GREATER,[ac]:i.NOTEQUAL};function Ne(S,p){if(p.type===Jt&&e.has("OES_texture_float_linear")===!1&&(p.magFilter===Tt||p.magFilter===Cr||p.magFilter===Ni||p.magFilter===Fn||p.minFilter===Tt||p.minFilter===Cr||p.minFilter===Ni||p.minFilter===Fn)&&Pe("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(S,i.TEXTURE_WRAP_S,Ee[p.wrapS]),i.texParameteri(S,i.TEXTURE_WRAP_T,Ee[p.wrapT]),(S===i.TEXTURE_3D||S===i.TEXTURE_2D_ARRAY)&&i.texParameteri(S,i.TEXTURE_WRAP_R,Ee[p.wrapR]),i.texParameteri(S,i.TEXTURE_MAG_FILTER,We[p.magFilter]),i.texParameteri(S,i.TEXTURE_MIN_FILTER,We[p.minFilter]),p.compareFunction&&(i.texParameteri(S,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(S,i.TEXTURE_COMPARE_FUNC,Qe[p.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(p.magFilter===vt||p.minFilter!==Ni&&p.minFilter!==Fn||p.type===Jt&&e.has("OES_texture_float_linear")===!1)return;if(p.anisotropy>1||n.get(p).__currentAnisotropy){const N=e.get("EXT_texture_filter_anisotropic");i.texParameterf(S,N.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(p.anisotropy,r.getMaxAnisotropy())),n.get(p).__currentAnisotropy=p.anisotropy}}}function Z(S,p){let N=!1;S.__webglInit===void 0&&(S.__webglInit=!0,p.addEventListener("dispose",P));const X=p.source;let $=g.get(X);$===void 0&&($={},g.set(X,$));const re=V(p);if(re!==S.__cacheKey){$[re]===void 0&&($[re]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,N=!0),$[re].usedTimes++;const oe=$[S.__cacheKey];oe!==void 0&&($[S.__cacheKey].usedTimes--,oe.usedTimes===0&&L(p)),S.__cacheKey=re,S.__webglTexture=$[re].texture}return N}function he(S,p,N){return Math.floor(Math.floor(S/N)/p)}function se(S,p,N,X){const re=S.updateRanges;if(re.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,p.width,p.height,N,X,p.data);else{re.sort((me,ie)=>me.start-ie.start);let oe=0;for(let me=1;me<re.length;me++){const ie=re[oe],te=re[me],De=ie.start+ie.count,Ie=he(te.start,p.width,4),Je=he(ie.start,p.width,4);te.start<=De+1&&Ie===Je&&he(te.start+te.count-1,p.width,4)===Ie?ie.count=Math.max(ie.count,te.start+te.count-ie.start):(++oe,re[oe]=te)}re.length=oe+1;const k=t.getParameter(i.UNPACK_ROW_LENGTH),K=t.getParameter(i.UNPACK_SKIP_PIXELS),ue=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,p.width);for(let me=0,ie=re.length;me<ie;me++){const te=re[me],De=Math.floor(te.start/4),Ie=Math.ceil(te.count/4),Je=De%p.width,C=Math.floor(De/p.width),ae=Ie,Y=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Je),t.pixelStorei(i.UNPACK_SKIP_ROWS,C),t.texSubImage2D(i.TEXTURE_2D,0,Je,C,ae,Y,N,X,p.data)}S.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,k),t.pixelStorei(i.UNPACK_SKIP_PIXELS,K),t.pixelStorei(i.UNPACK_SKIP_ROWS,ue)}}function we(S,p,N){let X=i.TEXTURE_2D;(p.isDataArrayTexture||p.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),p.isData3DTexture&&(X=i.TEXTURE_3D);const $=Z(S,p),re=p.source;t.bindTexture(X,S.__webglTexture,i.TEXTURE0+N);const oe=n.get(re);if(re.version!==oe.__version||$===!0){if(t.activeTexture(i.TEXTURE0+N),(typeof ImageBitmap<"u"&&p.image instanceof ImageBitmap)===!1){const Y=qe.getPrimaries(qe.workingColorSpace),ge=p.colorSpace===bn?null:qe.getPrimaries(p.colorSpace),le=p.colorSpace===bn||Y===ge?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,p.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,le)}t.pixelStorei(i.UNPACK_ALIGNMENT,p.unpackAlignment);let K=f(p.image,!1,r.maxTextureSize);K=ee(p,K);const ue=s.convert(p.format,p.colorSpace),me=s.convert(p.type);let ie=T(p.internalFormat,ue,me,p.normalized,p.colorSpace,p.isVideoTexture);Ne(X,p);let te;const De=p.mipmaps,Ie=p.isVideoTexture!==!0,Je=oe.__version===void 0||$===!0,C=re.dataReady,ae=b(p,K);if(p.isDepthTexture)ie=D(p.format===On,p.type),Je&&(Ie?t.texStorage2D(i.TEXTURE_2D,1,ie,K.width,K.height):t.texImage2D(i.TEXTURE_2D,0,ie,K.width,K.height,0,ue,me,null));else if(p.isDataTexture)if(De.length>0){Ie&&Je&&t.texStorage2D(i.TEXTURE_2D,ae,ie,De[0].width,De[0].height);for(let Y=0,ge=De.length;Y<ge;Y++)te=De[Y],Ie?C&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,te.width,te.height,ue,me,te.data):t.texImage2D(i.TEXTURE_2D,Y,ie,te.width,te.height,0,ue,me,te.data);p.generateMipmaps=!1}else Ie?(Je&&t.texStorage2D(i.TEXTURE_2D,ae,ie,K.width,K.height),C&&se(p,K,ue,me)):t.texImage2D(i.TEXTURE_2D,0,ie,K.width,K.height,0,ue,me,K.data);else if(p.isCompressedTexture)if(p.isCompressedArrayTexture){Ie&&Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,ie,De[0].width,De[0].height,K.depth);for(let Y=0,ge=De.length;Y<ge;Y++)if(te=De[Y],p.format!==Wt)if(ue!==null)if(Ie){if(C)if(p.layerUpdates.size>0){const le=fo(te.width,te.height,p.format,p.type);for(const j of p.layerUpdates){const ye=te.data.subarray(j*le/te.data.BYTES_PER_ELEMENT,(j+1)*le/te.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,j,te.width,te.height,1,ue,ye)}p.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,te.width,te.height,K.depth,ue,te.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Y,ie,te.width,te.height,K.depth,0,te.data,0,0);else Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ie?C&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Y,0,0,0,te.width,te.height,K.depth,ue,me,te.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Y,ie,te.width,te.height,K.depth,0,ue,me,te.data)}else{Ie&&Je&&t.texStorage2D(i.TEXTURE_2D,ae,ie,De[0].width,De[0].height);for(let Y=0,ge=De.length;Y<ge;Y++)te=De[Y],p.format!==Wt?ue!==null?Ie?C&&t.compressedTexSubImage2D(i.TEXTURE_2D,Y,0,0,te.width,te.height,ue,te.data):t.compressedTexImage2D(i.TEXTURE_2D,Y,ie,te.width,te.height,0,te.data):Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ie?C&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,te.width,te.height,ue,me,te.data):t.texImage2D(i.TEXTURE_2D,Y,ie,te.width,te.height,0,ue,me,te.data)}else if(p.isDataArrayTexture)if(Ie){if(Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,ie,K.width,K.height,K.depth),C)if(p.layerUpdates.size>0){const Y=fo(K.width,K.height,p.format,p.type);for(const ge of p.layerUpdates){const le=K.data.subarray(ge*Y/K.data.BYTES_PER_ELEMENT,(ge+1)*Y/K.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ge,K.width,K.height,1,ue,me,le)}p.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,K.width,K.height,K.depth,ue,me,K.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,ie,K.width,K.height,K.depth,0,ue,me,K.data);else if(p.isData3DTexture)Ie?(Je&&t.texStorage3D(i.TEXTURE_3D,ae,ie,K.width,K.height,K.depth),C&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,K.width,K.height,K.depth,ue,me,K.data)):t.texImage3D(i.TEXTURE_3D,0,ie,K.width,K.height,K.depth,0,ue,me,K.data);else if(p.isFramebufferTexture){if(Je)if(Ie)t.texStorage2D(i.TEXTURE_2D,ae,ie,K.width,K.height);else{let Y=K.width,ge=K.height;for(let le=0;le<ae;le++)t.texImage2D(i.TEXTURE_2D,le,ie,Y,ge,0,ue,me,null),Y>>=1,ge>>=1}}else if(p.isHTMLTexture){if("texElementImage2D"in i){const Y=i.canvas;if(Y.hasAttribute("layoutsubtree")||Y.setAttribute("layoutsubtree","true"),K.parentNode!==Y){Y.appendChild(K),m.add(p),Y.onpaint=Oe=>{const ft=Oe.changedElements;for(const it of m)ft.includes(it.image)&&(it.needsUpdate=!0)},Y.requestPaint();return}const ge=0,le=i.RGBA,j=i.RGBA,ye=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,ge,le,j,ye,K),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(De.length>0){if(Ie&&Je){const Y=Ze(De[0]);t.texStorage2D(i.TEXTURE_2D,ae,ie,Y.width,Y.height)}for(let Y=0,ge=De.length;Y<ge;Y++)te=De[Y],Ie?C&&t.texSubImage2D(i.TEXTURE_2D,Y,0,0,ue,me,te):t.texImage2D(i.TEXTURE_2D,Y,ie,ue,me,te);p.generateMipmaps=!1}else if(Ie){if(Je){const Y=Ze(K);t.texStorage2D(i.TEXTURE_2D,ae,ie,Y.width,Y.height)}C&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ue,me,K)}else t.texImage2D(i.TEXTURE_2D,0,ie,ue,me,K);h(p)&&M(X),oe.__version=re.version,p.onUpdate&&p.onUpdate(p)}S.__version=p.version}function Le(S,p,N){if(p.image.length!==6)return;const X=Z(S,p),$=p.source;t.bindTexture(i.TEXTURE_CUBE_MAP,S.__webglTexture,i.TEXTURE0+N);const re=n.get($);if($.version!==re.__version||X===!0){t.activeTexture(i.TEXTURE0+N);const oe=qe.getPrimaries(qe.workingColorSpace),k=p.colorSpace===bn?null:qe.getPrimaries(p.colorSpace),K=p.colorSpace===bn||oe===k?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,p.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,p.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,p.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,K);const ue=p.isCompressedTexture||p.image[0].isCompressedTexture,me=p.image[0]&&p.image[0].isDataTexture,ie=[];for(let j=0;j<6;j++)!ue&&!me?ie[j]=f(p.image[j],!0,r.maxCubemapSize):ie[j]=me?p.image[j].image:p.image[j],ie[j]=ee(p,ie[j]);const te=ie[0],De=s.convert(p.format,p.colorSpace),Ie=s.convert(p.type),Je=T(p.internalFormat,De,Ie,p.normalized,p.colorSpace),C=p.isVideoTexture!==!0,ae=re.__version===void 0||X===!0,Y=$.dataReady;let ge=b(p,te);Ne(i.TEXTURE_CUBE_MAP,p);let le;if(ue){C&&ae&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Je,te.width,te.height);for(let j=0;j<6;j++){le=ie[j].mipmaps;for(let ye=0;ye<le.length;ye++){const Oe=le[ye];p.format!==Wt?De!==null?C?Y&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye,0,0,Oe.width,Oe.height,De,Oe.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye,Je,Oe.width,Oe.height,0,Oe.data):Pe("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):C?Y&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye,0,0,Oe.width,Oe.height,De,Ie,Oe.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye,Je,Oe.width,Oe.height,0,De,Ie,Oe.data)}}}else{if(le=p.mipmaps,C&&ae){le.length>0&&ge++;const j=Ze(ie[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ge,Je,j.width,j.height)}for(let j=0;j<6;j++)if(me){C?Y&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,ie[j].width,ie[j].height,De,Ie,ie[j].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Je,ie[j].width,ie[j].height,0,De,Ie,ie[j].data);for(let ye=0;ye<le.length;ye++){const ft=le[ye].image[j].image;C?Y&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye+1,0,0,ft.width,ft.height,De,Ie,ft.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye+1,Je,ft.width,ft.height,0,De,Ie,ft.data)}}else{C?Y&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,De,Ie,ie[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Je,De,Ie,ie[j]);for(let ye=0;ye<le.length;ye++){const Oe=le[ye];C?Y&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye+1,0,0,De,Ie,Oe.image[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,ye+1,Je,De,Ie,Oe.image[j])}}}h(p)&&M(i.TEXTURE_CUBE_MAP),re.__version=$.version,p.onUpdate&&p.onUpdate(p)}S.__version=p.version}function Ce(S,p,N,X,$,re){const oe=s.convert(N.format,N.colorSpace),k=s.convert(N.type),K=T(N.internalFormat,oe,k,N.normalized,N.colorSpace),ue=n.get(p),me=n.get(N);if(me.__renderTarget=p,!ue.__hasExternalTextures){const ie=Math.max(1,p.width>>re),te=Math.max(1,p.height>>re);$===i.TEXTURE_3D||$===i.TEXTURE_2D_ARRAY?t.texImage3D($,re,K,ie,te,p.depth,0,oe,k,null):t.texImage2D($,re,K,ie,te,0,oe,k,null)}t.bindFramebuffer(i.FRAMEBUFFER,S),Q(p)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,$,me.__webglTexture,0,Xe(p)):($===i.TEXTURE_2D||$>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&$<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,$,me.__webglTexture,re),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ot(S,p,N){if(i.bindRenderbuffer(i.RENDERBUFFER,S),p.depthBuffer){const X=p.depthTexture,$=X&&X.isDepthTexture?X.type:null,re=D(p.stencilBuffer,$),oe=p.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Q(p)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Xe(p),re,p.width,p.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,Xe(p),re,p.width,p.height):i.renderbufferStorage(i.RENDERBUFFER,re,p.width,p.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,oe,i.RENDERBUFFER,S)}else{const X=p.textures;for(let $=0;$<X.length;$++){const re=X[$],oe=s.convert(re.format,re.colorSpace),k=s.convert(re.type),K=T(re.internalFormat,oe,k,re.normalized,re.colorSpace);Q(p)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Xe(p),K,p.width,p.height):N?i.renderbufferStorageMultisample(i.RENDERBUFFER,Xe(p),K,p.width,p.height):i.renderbufferStorage(i.RENDERBUFFER,K,p.width,p.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function He(S,p,N){const X=p.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,S),!(p.depthTexture&&p.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const $=n.get(p.depthTexture);if($.__renderTarget=p,(!$.__webglTexture||p.depthTexture.image.width!==p.width||p.depthTexture.image.height!==p.height)&&(p.depthTexture.image.width=p.width,p.depthTexture.image.height=p.height,p.depthTexture.needsUpdate=!0),X){if($.__webglInit===void 0&&($.__webglInit=!0,p.depthTexture.addEventListener("dispose",P)),$.__webglTexture===void 0){$.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,$.__webglTexture),Ne(i.TEXTURE_CUBE_MAP,p.depthTexture);const ue=s.convert(p.depthTexture.format),me=s.convert(p.depthTexture.type);let ie;p.depthTexture.format===mn?ie=i.DEPTH_COMPONENT24:p.depthTexture.format===On&&(ie=i.DEPTH24_STENCIL8);for(let te=0;te<6;te++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,ie,p.width,p.height,0,ue,me,null)}}else J(p.depthTexture,0);const re=$.__webglTexture,oe=Xe(p),k=X?i.TEXTURE_CUBE_MAP_POSITIVE_X+N:i.TEXTURE_2D,K=p.depthTexture.format===On?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(p.depthTexture.format===mn)Q(p)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,k,re,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,K,k,re,0);else if(p.depthTexture.format===On)Q(p)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,k,re,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,K,k,re,0);else throw new Error("Unknown depthTexture format")}function et(S){const p=n.get(S),N=S.isWebGLCubeRenderTarget===!0;if(p.__boundDepthTexture!==S.depthTexture){const X=S.depthTexture;if(p.__depthDisposeCallback&&p.__depthDisposeCallback(),X){const $=()=>{delete p.__boundDepthTexture,delete p.__depthDisposeCallback,X.removeEventListener("dispose",$)};X.addEventListener("dispose",$),p.__depthDisposeCallback=$}p.__boundDepthTexture=X}if(S.depthTexture&&!p.__autoAllocateDepthBuffer)if(N)for(let X=0;X<6;X++)He(p.__webglFramebuffer[X],S,X);else{const X=S.texture.mipmaps;X&&X.length>0?He(p.__webglFramebuffer[0],S,0):He(p.__webglFramebuffer,S,0)}else if(N){p.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(i.FRAMEBUFFER,p.__webglFramebuffer[X]),p.__webglDepthbuffer[X]===void 0)p.__webglDepthbuffer[X]=i.createRenderbuffer(),ot(p.__webglDepthbuffer[X],S,!1);else{const $=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=p.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,re)}}else{const X=S.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(i.FRAMEBUFFER,p.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,p.__webglFramebuffer),p.__webglDepthbuffer===void 0)p.__webglDepthbuffer=i.createRenderbuffer(),ot(p.__webglDepthbuffer,S,!1);else{const $=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,re=p.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,re),i.framebufferRenderbuffer(i.FRAMEBUFFER,$,i.RENDERBUFFER,re)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function nt(S,p,N){const X=n.get(S);p!==void 0&&Ce(X.__webglFramebuffer,S,S.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),N!==void 0&&et(S)}function ze(S){const p=S.texture,N=n.get(S),X=n.get(p);S.addEventListener("dispose",_);const $=S.textures,re=S.isWebGLCubeRenderTarget===!0,oe=$.length>1;if(oe||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=p.version,a.memory.textures++),re){N.__webglFramebuffer=[];for(let k=0;k<6;k++)if(p.mipmaps&&p.mipmaps.length>0){N.__webglFramebuffer[k]=[];for(let K=0;K<p.mipmaps.length;K++)N.__webglFramebuffer[k][K]=i.createFramebuffer()}else N.__webglFramebuffer[k]=i.createFramebuffer()}else{if(p.mipmaps&&p.mipmaps.length>0){N.__webglFramebuffer=[];for(let k=0;k<p.mipmaps.length;k++)N.__webglFramebuffer[k]=i.createFramebuffer()}else N.__webglFramebuffer=i.createFramebuffer();if(oe)for(let k=0,K=$.length;k<K;k++){const ue=n.get($[k]);ue.__webglTexture===void 0&&(ue.__webglTexture=i.createTexture(),a.memory.textures++)}if(S.samples>0&&Q(S)===!1){N.__webglMultisampledFramebuffer=i.createFramebuffer(),N.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,N.__webglMultisampledFramebuffer);for(let k=0;k<$.length;k++){const K=$[k];N.__webglColorRenderbuffer[k]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,N.__webglColorRenderbuffer[k]);const ue=s.convert(K.format,K.colorSpace),me=s.convert(K.type),ie=T(K.internalFormat,ue,me,K.normalized,K.colorSpace,S.isXRRenderTarget===!0),te=Xe(S);i.renderbufferStorageMultisample(i.RENDERBUFFER,te,ie,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+k,i.RENDERBUFFER,N.__webglColorRenderbuffer[k])}i.bindRenderbuffer(i.RENDERBUFFER,null),S.depthBuffer&&(N.__webglDepthRenderbuffer=i.createRenderbuffer(),ot(N.__webglDepthRenderbuffer,S,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(re){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),Ne(i.TEXTURE_CUBE_MAP,p);for(let k=0;k<6;k++)if(p.mipmaps&&p.mipmaps.length>0)for(let K=0;K<p.mipmaps.length;K++)Ce(N.__webglFramebuffer[k][K],S,p,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,K);else Ce(N.__webglFramebuffer[k],S,p,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0);h(p)&&M(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(oe){for(let k=0,K=$.length;k<K;k++){const ue=$[k],me=n.get(ue);let ie=i.TEXTURE_2D;(S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(ie=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,me.__webglTexture),Ne(ie,ue),Ce(N.__webglFramebuffer,S,ue,i.COLOR_ATTACHMENT0+k,ie,0),h(ue)&&M(ie)}t.unbindTexture()}else{let k=i.TEXTURE_2D;if((S.isWebGL3DRenderTarget||S.isWebGLArrayRenderTarget)&&(k=S.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(k,X.__webglTexture),Ne(k,p),p.mipmaps&&p.mipmaps.length>0)for(let K=0;K<p.mipmaps.length;K++)Ce(N.__webglFramebuffer[K],S,p,i.COLOR_ATTACHMENT0,k,K);else Ce(N.__webglFramebuffer,S,p,i.COLOR_ATTACHMENT0,k,0);h(p)&&M(k),t.unbindTexture()}S.depthBuffer&&et(S)}function Me(S){const p=S.textures;for(let N=0,X=p.length;N<X;N++){const $=p[N];if(h($)){const re=y(S),oe=n.get($).__webglTexture;t.bindTexture(re,oe),M(re),t.unbindTexture()}}}const Ue=[],Re=[];function R(S){if(S.samples>0){if(Q(S)===!1){const p=S.textures,N=S.width,X=S.height;let $=i.COLOR_BUFFER_BIT;const re=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=n.get(S),k=p.length>1;if(k)for(let ue=0;ue<p.length;ue++)t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,oe.__webglMultisampledFramebuffer);const K=S.texture.mipmaps;K&&K.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglFramebuffer);for(let ue=0;ue<p.length;ue++){if(S.resolveDepthBuffer&&(S.depthBuffer&&($|=i.DEPTH_BUFFER_BIT),S.stencilBuffer&&S.resolveStencilBuffer&&($|=i.STENCIL_BUFFER_BIT)),k){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,oe.__webglColorRenderbuffer[ue]);const me=n.get(p[ue]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,me,0)}i.blitFramebuffer(0,0,N,X,0,0,N,X,$,i.NEAREST),c===!0&&(Ue.length=0,Re.length=0,Ue.push(i.COLOR_ATTACHMENT0+ue),S.depthBuffer&&S.resolveDepthBuffer===!1&&(Ue.push(re),Re.push(re),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Re)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Ue))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),k)for(let ue=0;ue<p.length;ue++){t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.RENDERBUFFER,oe.__webglColorRenderbuffer[ue]);const me=n.get(p[ue]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,oe.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+ue,i.TEXTURE_2D,me,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,oe.__webglMultisampledFramebuffer)}else if(S.depthBuffer&&S.resolveDepthBuffer===!1&&c){const p=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[p])}}}function Xe(S){return Math.min(r.maxSamples,S.samples)}function Q(S){const p=n.get(S);return S.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&p.__useRenderToTexture!==!1}function be(S){const p=a.render.frame;d.get(S)!==p&&(d.set(S,p),S.update())}function ee(S,p){const N=S.colorSpace,X=S.format,$=S.type;return S.isCompressedTexture===!0||S.isVideoTexture===!0||N!==gr&&N!==bn&&(qe.getTransfer(N)===tt?(X!==Wt||$!==Ft)&&Pe("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):je("WebGLTextures: Unsupported texture color space:",N)),p}function Ze(S){return typeof HTMLImageElement<"u"&&S instanceof HTMLImageElement?(l.width=S.naturalWidth||S.width,l.height=S.naturalHeight||S.height):typeof VideoFrame<"u"&&S instanceof VideoFrame?(l.width=S.displayWidth,l.height=S.displayHeight):(l.width=S.width,l.height=S.height),l}this.allocateTextureUnit=G,this.resetTextureUnits=q,this.getTextureUnits=W,this.setTextureUnits=I,this.setTexture2D=J,this.setTexture2DArray=ne,this.setTexture3D=ce,this.setTextureCube=ve,this.rebindTextures=nt,this.setupRenderTarget=ze,this.updateRenderTargetMipmap=Me,this.updateMultisampleRenderTarget=R,this.setupDepthRenderbuffer=et,this.setupFrameBufferTexture=Ce,this.useMultisampledRTT=Q,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Gp(i,e){function t(n,r=bn){let s;const a=qe.getTransfer(r);if(n===Ft)return i.UNSIGNED_BYTE;if(n===na)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ia)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Ko)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Zo)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===qo)return i.BYTE;if(n===Yo)return i.SHORT;if(n===bi)return i.UNSIGNED_SHORT;if(n===ta)return i.INT;if(n===nn)return i.UNSIGNED_INT;if(n===Jt)return i.FLOAT;if(n===pn)return i.HALF_FLOAT;if(n===$o)return i.ALPHA;if(n===jo)return i.RGB;if(n===Wt)return i.RGBA;if(n===mn)return i.DEPTH_COMPONENT;if(n===On)return i.DEPTH_STENCIL;if(n===Jo)return i.RED;if(n===ra)return i.RED_INTEGER;if(n===zn)return i.RG;if(n===sa)return i.RG_INTEGER;if(n===aa)return i.RGBA_INTEGER;if(n===lr||n===cr||n===ur||n===hr)if(a===tt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===lr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===cr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ur)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===hr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===lr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===cr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ur)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===hr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===vs||n===Ms||n===Ss||n===Es)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===vs)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ms)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Ss)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Es)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ys||n===Ts||n===bs||n===As||n===Rs||n===pr||n===ws)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ys||n===Ts)return a===tt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===bs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===As)return s.COMPRESSED_R11_EAC;if(n===Rs)return s.COMPRESSED_SIGNED_R11_EAC;if(n===pr)return s.COMPRESSED_RG11_EAC;if(n===ws)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Cs||n===Ps||n===Ds||n===Ls||n===Us||n===Is||n===Ns||n===Fs||n===Os||n===Bs||n===zs||n===Gs||n===Vs||n===Hs)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Cs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Ps)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ds)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ls)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Us)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Is)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Ns)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Fs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Os)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Bs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===zs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Gs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Vs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Hs)return a===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ks||n===Ws||n===Xs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===ks)return a===tt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Ws)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Xs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===qs||n===Ys||n===mr||n===Ks)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===qs)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Ys)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===mr)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Ks)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ai?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Vp=`
void main() {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
...
}`;class kp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new ll(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new qt({vertexShader:Vp,fragmentShader:Hp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Xt(new Li(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Wp extends Vn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,d=null,m=null,u=null,g=null,v=null;const E=typeof XRWebGLBinding<"u",f=new kp,h={},M=t.getContextAttributes();let y=null,T=null;const D=[],b=[],P=new Ke;let _=null;const A=new Nt;A.viewport=new ht;const L=new Nt;L.viewport=new ht;const w=[A,L],O=new Jc;let q=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let he=D[Z];return he===void 0&&(he=new Or,D[Z]=he),he.getTargetRaySpace()},this.getControllerGrip=function(Z){let he=D[Z];return he===void 0&&(he=new Or,D[Z]=he),he.getGripSpace()},this.getHand=function(Z){let he=D[Z];return he===void 0&&(he=new Or,D[Z]=he),he.getHandSpace()};function I(Z){const he=b.indexOf(Z.inputSource);if(he===-1)return;const se=D[he];se!==void 0&&(se.update(Z.inputSource,Z.frame,l||a),se.dispatchEvent({type:Z.type,data:Z.inputSource}))}function G(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",G),r.removeEventListener("inputsourceschange",V);for(let Z=0;Z<D.length;Z++){const he=b[Z];he!==null&&(b[Z]=null,D[Z].disconnect(he))}q=null,W=null,f.reset();for(const Z in h)delete h[Z];e.setRenderTarget(y),g=null,u=null,m=null,r=null,T=null,Ne.stop(),n.isPresenting=!1,e.setPixelRatio(_),e.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,n.isPresenting===!0&&Pe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&Pe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Z){l=Z},this.getBaseLayer=function(){return u!==null?u:g},this.getBinding=function(){return m===null&&E&&(m=new XRWebGLBinding(r,t)),m},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(Z){if(r=Z,r!==null){if(y=e.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",G),r.addEventListener("inputsourceschange",V),M.xrCompatible!==!0&&await t.makeXRCompatible(),_=e.getPixelRatio(),e.getSize(P),E&&"createProjectionLayer"in XRWebGLBinding.prototype){let se=null,we=null,Le=null;M.depth&&(Le=M.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,se=M.stencil?On:mn,we=M.stencil?Ai:nn);const Ce={colorFormat:t.RGBA8,depthFormat:Le,scaleFactor:s};m=this.getBinding(),u=m.createProjectionLayer(Ce),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),T=new tn(u.textureWidth,u.textureHeight,{format:Wt,type:Ft,depthTexture:new li(u.textureWidth,u.textureHeight,we,void 0,void 0,void 0,void 0,void 0,void 0,se),stencilBuffer:M.stencil,colorSpace:e.outputColorSpace,samples:M.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const se={antialias:M.antialias,alpha:!0,depth:M.depth,stencil:M.stencil,framebufferScaleFactor:s};g=new XRWebGLLayer(r,t,se),r.updateRenderState({baseLayer:g}),e.setPixelRatio(1),e.setSize(g.framebufferWidth,g.framebufferHeight,!1),T=new tn(g.framebufferWidth,g.framebufferHeight,{format:Wt,type:Ft,colorSpace:e.outputColorSpace,stencilBuffer:M.stencil,resolveDepthBuffer:g.ignoreDepthValues===!1,resolveStencilBuffer:g.ignoreDepthValues===!1})}T.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),Ne.setContext(r),Ne.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return f.getDepthTexture()};function V(Z){for(let he=0;he<Z.removed.length;he++){const se=Z.removed[he],we=b.indexOf(se);we>=0&&(b[we]=null,D[we].disconnect(se))}for(let he=0;he<Z.added.length;he++){const se=Z.added[he];let we=b.indexOf(se);if(we===-1){for(let Ce=0;Ce<D.length;Ce++)if(Ce>=b.length){b.push(se),we=Ce;break}else if(b[Ce]===null){b[Ce]=se,we=Ce;break}if(we===-1)break}const Le=D[we];Le&&Le.connect(se)}}const J=new F,ne=new F;function ce(Z,he,se){J.setFromMatrixPosition(he.matrixWorld),ne.setFromMatrixPosition(se.matrixWorld);const we=J.distanceTo(ne),Le=he.projectionMatrix.elements,Ce=se.projectionMatrix.elements,ot=Le[14]/(Le[10]-1),He=Le[14]/(Le[10]+1),et=(Le[9]+1)/Le[5],nt=(Le[9]-1)/Le[5],ze=(Le[8]-1)/Le[0],Me=(Ce[8]+1)/Ce[0],Ue=ot*ze,Re=ot*Me,R=we/(-ze+Me),Xe=R*-ze;if(he.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(Xe),Z.translateZ(R),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),Le[10]===-1)Z.projectionMatrix.copy(he.projectionMatrix),Z.projectionMatrixInverse.copy(he.projectionMatrixInverse);else{const Q=ot+R,be=He+R,ee=Ue-Xe,Ze=Re+(we-Xe),S=et*He/be*Q,p=nt*He/be*Q;Z.projectionMatrix.makePerspective(ee,Ze,S,p,Q,be),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function ve(Z,he){he===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(he.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(r===null)return;let he=Z.near,se=Z.far;f.texture!==null&&(f.depthNear>0&&(he=f.depthNear),f.depthFar>0&&(se=f.depthFar)),O.near=L.near=A.near=he,O.far=L.far=A.far=se,(q!==O.near||W!==O.far)&&(r.updateRenderState({depthNear:O.near,depthFar:O.far}),q=O.near,W=O.far),O.layers.mask=Z.layers.mask|6,A.layers.mask=O.layers.mask&-5,L.layers.mask=O.layers.mask&-3;const we=Z.parent,Le=O.cameras;ve(O,we);for(let Ce=0;Ce<Le.length;Ce++)ve(Le[Ce],we);Le.length===2?ce(O,A,L):O.projectionMatrix.copy(A.projectionMatrix),Ee(Z,O,we)};function Ee(Z,he,se){se===null?Z.matrix.copy(he.matrixWorld):(Z.matrix.copy(se.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(he.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(he.projectionMatrix),Z.projectionMatrixInverse.copy(he.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=$s*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return O},this.getFoveation=function(){if(!(u===null&&g===null))return c},this.setFoveation=function(Z){c=Z,u!==null&&(u.fixedFoveation=Z),g!==null&&g.fixedFoveation!==void 0&&(g.fixedFoveation=Z)},this.hasDepthSensing=function(){return f.texture!==null},this.getDepthSensingMesh=function(){return f.getMesh(O)},this.getCameraTexture=function(Z){return h[Z]};let We=null;function Qe(Z,he){if(d=he.getViewerPose(l||a),v=he,d!==null){const se=d.views;g!==null&&(e.setRenderTargetFramebuffer(T,g.framebuffer),e.setRenderTarget(T));let we=!1;se.length!==O.cameras.length&&(O.cameras.length=0,we=!0);for(let He=0;He<se.length;He++){const et=se[He];let nt=null;if(g!==null)nt=g.getViewport(et);else{const Me=m.getViewSubImage(u,et);nt=Me.viewport,He===0&&(e.setRenderTargetTextures(T,Me.colorTexture,Me.depthStencilTexture),e.setRenderTarget(T))}let ze=w[He];ze===void 0&&(ze=new Nt,ze.layers.enable(He),ze.viewport=new ht,w[He]=ze),ze.matrix.fromArray(et.transform.matrix),ze.matrix.decompose(ze.position,ze.quaternion,ze.scale),ze.projectionMatrix.fromArray(et.projectionMatrix),ze.projectionMatrixInverse.copy(ze.projectionMatrix).invert(),ze.viewport.set(nt.x,nt.y,nt.width,nt.height),He===0&&(O.matrix.copy(ze.matrix),O.matrix.decompose(O.position,O.quaternion,O.scale)),we===!0&&O.cameras.push(ze)}const Le=r.enabledFeatures;if(Le&&Le.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&E){m=n.getBinding();const He=m.getDepthInformation(se[0]);He&&He.isValid&&He.texture&&f.init(He,r.renderState)}if(Le&&Le.includes("camera-access")&&E){e.state.unbindTexture(),m=n.getBinding();for(let He=0;He<se.length;He++){const et=se[He].camera;if(et){let nt=h[et];nt||(nt=new ll,h[et]=nt);const ze=m.getCameraImage(et);nt.sourceTexture=ze}}}}for(let se=0;se<D.length;se++){const we=b[se],Le=D[se];we!==null&&Le!==void 0&&Le.update(we,he,l||a)}We&&We(Z,he),he.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:he}),v=null}const Ne=new dl;Ne.setAnimationLoop(Qe),this.setAnimationLoop=function(Z){We=Z},this.dispose=function(){}}}const Xp=new ct,Ml=new Fe;Ml.set(-1,0,0,0,1,0,0,0,1);function qp(i,e){function t(f,h){f.matrixAutoUpdate===!0&&f.updateMatrix(),h.value.copy(f.matrix)}function n(f,h){h.color.getRGB(f.fogColor.value,cl(i)),h.isFog?(f.fogNear.value=h.near,f.fogFar.value=h.far):h.isFogExp2&&(f.fogDensity.value=h.density)}function r(f,h,M,y,T){h.isNodeMaterial?h.uniformsNeedUpdate=!1:h.isMeshBasicMaterial?s(f,h):h.isMeshLambertMaterial?(s(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(s(f,h),m(f,h)):h.isMeshPhongMaterial?(s(f,h),d(f,h),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(s(f,h),u(f,h),h.isMeshPhysicalMaterial&&g(f,h,T)):h.isMeshMatcapMaterial?(s(f,h),v(f,h)):h.isMeshDepthMaterial?s(f,h):h.isMeshDistanceMaterial?(s(f,h),E(f,h)):h.isMeshNormalMaterial?s(f,h):h.isLineBasicMaterial?(a(f,h),h.isLineDashedMaterial&&o(f,h)):h.isPointsMaterial?c(f,h,M,y):h.isSpriteMaterial?l(f,h):h.isShadowMaterial?(f.color.value.copy(h.color),f.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(f,h){f.opacity.value=h.opacity,h.color&&f.diffuse.value.copy(h.color),h.emissive&&f.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.bumpMap&&(f.bumpMap.value=h.bumpMap,t(h.bumpMap,f.bumpMapTransform),f.bumpScale.value=h.bumpScale,h.side===Dt&&(f.bumpScale.value*=-1)),h.normalMap&&(f.normalMap.value=h.normalMap,t(h.normalMap,f.normalMapTransform),f.normalScale.value.copy(h.normalScale),h.side===Dt&&f.normalScale.value.negate()),h.displacementMap&&(f.displacementMap.value=h.displacementMap,t(h.displacementMap,f.displacementMapTransform),f.displacementScale.value=h.displacementScale,f.displacementBias.value=h.displacementBias),h.emissiveMap&&(f.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,f.emissiveMapTransform)),h.specularMap&&(f.specularMap.value=h.specularMap,t(h.specularMap,f.specularMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest);const M=e.get(h),y=M.envMap,T=M.envMapRotation;y&&(f.envMap.value=y,f.envMapRotation.value.setFromMatrix4(Xp.makeRotationFromEuler(T)).transpose(),y.isCubeTexture&&y.isRenderTargetTexture===!1&&f.envMapRotation.value.premultiply(Ml),f.reflectivity.value=h.reflectivity,f.ior.value=h.ior,f.refractionRatio.value=h.refractionRatio),h.lightMap&&(f.lightMap.value=h.lightMap,f.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,f.lightMapTransform)),h.aoMap&&(f.aoMap.value=h.aoMap,f.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,f.aoMapTransform))}function a(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform))}function o(f,h){f.dashSize.value=h.dashSize,f.totalSize.value=h.dashSize+h.gapSize,f.scale.value=h.scale}function c(f,h,M,y){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.size.value=h.size*M,f.scale.value=y*.5,h.map&&(f.map.value=h.map,t(h.map,f.uvTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function l(f,h){f.diffuse.value.copy(h.color),f.opacity.value=h.opacity,f.rotation.value=h.rotation,h.map&&(f.map.value=h.map,t(h.map,f.mapTransform)),h.alphaMap&&(f.alphaMap.value=h.alphaMap,t(h.alphaMap,f.alphaMapTransform)),h.alphaTest>0&&(f.alphaTest.value=h.alphaTest)}function d(f,h){f.specular.value.copy(h.specular),f.shininess.value=Math.max(h.shininess,1e-4)}function m(f,h){h.gradientMap&&(f.gradientMap.value=h.gradientMap)}function u(f,h){f.metalness.value=h.metalness,h.metalnessMap&&(f.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,f.metalnessMapTransform)),f.roughness.value=h.roughness,h.roughnessMap&&(f.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,f.roughnessMapTransform)),h.envMap&&(f.envMapIntensity.value=h.envMapIntensity)}function g(f,h,M){f.ior.value=h.ior,h.sheen>0&&(f.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),f.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(f.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,f.sheenColorMapTransform)),h.sheenRoughnessMap&&(f.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,f.sheenRoughnessMapTransform))),h.clearcoat>0&&(f.clearcoat.value=h.clearcoat,f.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(f.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,f.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(f.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,f.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(f.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,f.clearcoatNormalMapTransform),f.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Dt&&f.clearcoatNormalScale.value.negate())),h.dispersion>0&&(f.dispersion.value=h.dispersion),h.iridescence>0&&(f.iridescence.value=h.iridescence,f.iridescenceIOR.value=h.iridescenceIOR,f.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],f.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(f.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,f.iridescenceMapTransform)),h.iridescenceThicknessMap&&(f.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,f.iridescenceThicknessMapTransform))),h.transmission>0&&(f.transmission.value=h.transmission,f.transmissionSamplerMap.value=M.texture,f.transmissionSamplerSize.value.set(M.width,M.height),h.transmissionMap&&(f.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,f.transmissionMapTransform)),f.thickness.value=h.thickness,h.thicknessMap&&(f.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,f.thicknessMapTransform)),f.attenuationDistance.value=h.attenuationDistance,f.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(f.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(f.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,f.anisotropyMapTransform))),f.specularIntensity.value=h.specularIntensity,f.specularColor.value.copy(h.specularColor),h.specularColorMap&&(f.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,f.specularColorMapTransform)),h.specularIntensityMap&&(f.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,f.specularIntensityMapTransform))}function v(f,h){h.matcap&&(f.matcap.value=h.matcap)}function E(f,h){const M=e.get(h).light;f.referencePosition.value.setFromMatrixPosition(M.matrixWorld),f.nearDistance.value=M.shadow.camera.near,f.farDistance.value=M.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Yp(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(M,y){const T=y.program;n.uniformBlockBinding(M,T)}function l(M,y){let T=r[M.id];T===void 0&&(v(M),T=d(M),r[M.id]=T,M.addEventListener("dispose",f));const D=y.program;n.updateUBOMapping(M,D);const b=e.render.frame;s[M.id]!==b&&(u(M),s[M.id]=b)}function d(M){const y=m();M.__bindingPointIndex=y;const T=i.createBuffer(),D=M.__size,b=M.usage;return i.bindBuffer(i.UNIFORM_BUFFER,T),i.bufferData(i.UNIFORM_BUFFER,D,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,y,T),T}function m(){for(let M=0;M<o;M++)if(a.indexOf(M)===-1)return a.push(M),M;return je("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(M){const y=r[M.id],T=M.uniforms,D=M.__cache;i.bindBuffer(i.UNIFORM_BUFFER,y);for(let b=0,P=T.length;b<P;b++){const _=Array.isArray(T[b])?T[b]:[T[b]];for(let A=0,L=_.length;A<L;A++){const w=_[A];if(g(w,b,A,D)===!0){const O=w.__offset,q=Array.isArray(w.value)?w.value:[w.value];let W=0;for(let I=0;I<q.length;I++){const G=q[I],V=E(G);typeof G=="number"||typeof G=="boolean"?(w.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,O+W,w.__data)):G.isMatrix3?(w.__data[0]=G.elements[0],w.__data[1]=G.elements[1],w.__data[2]=G.elements[2],w.__data[3]=0,w.__data[4]=G.elements[3],w.__data[5]=G.elements[4],w.__data[6]=G.elements[5],w.__data[7]=0,w.__data[8]=G.elements[6],w.__data[9]=G.elements[7],w.__data[10]=G.elements[8],w.__data[11]=0):ArrayBuffer.isView(G)?w.__data.set(new G.constructor(G.buffer,G.byteOffset,w.__data.length)):(G.toArray(w.__data,W),W+=V.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,O,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function g(M,y,T,D){const b=M.value,P=y+"_"+T;if(D[P]===void 0)return typeof b=="number"||typeof b=="boolean"?D[P]=b:ArrayBuffer.isView(b)?D[P]=b.slice():D[P]=b.clone(),!0;{const _=D[P];if(typeof b=="number"||typeof b=="boolean"){if(_!==b)return D[P]=b,!0}else{if(ArrayBuffer.isView(b))return!0;if(_.equals(b)===!1)return _.copy(b),!0}}return!1}function v(M){const y=M.uniforms;let T=0;const D=16;for(let P=0,_=y.length;P<_;P++){const A=Array.isArray(y[P])?y[P]:[y[P]];for(let L=0,w=A.length;L<w;L++){const O=A[L],q=Array.isArray(O.value)?O.value:[O.value];for(let W=0,I=q.length;W<I;W++){const G=q[W],V=E(G),J=T%D,ne=J%V.boundary,ce=J+ne;T+=ne,ce!==0&&D-ce<V.storage&&(T+=D-ce),O.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),O.__offset=T,T+=V.storage}}}const b=T%D;return b>0&&(T+=D-b),M.__size=T,M.__cache={},this}function E(M){const y={boundary:0,storage:0};return typeof M=="number"||typeof M=="boolean"?(y.boundary=4,y.storage=4):M.isVector2?(y.boundary=8,y.storage=8):M.isVector3||M.isColor?(y.boundary=16,y.storage=12):M.isVector4?(y.boundary=16,y.storage=16):M.isMatrix3?(y.boundary=48,y.storage=48):M.isMatrix4?(y.boundary=64,y.storage=64):M.isTexture?Pe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(M)?(y.boundary=16,y.storage=M.byteLength):Pe("WebGLRenderer: Unsupported uniform value type.",M),y}function f(M){const y=M.target;y.removeEventListener("dispose",f);const T=a.indexOf(y.__bindingPointIndex);a.splice(T,1),i.deleteBuffer(r[y.id]),delete r[y.id],delete s[y.id]}function h(){for(const M in r)i.deleteBuffer(r[M]);a=[],r={},s={}}return{bind:c,update:l,dispose:h}}const Kp=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let $t=null;function Zp(){return $t===null&&($t=new Lc(Kp,16,16,zn,pn),$t.name="DFG_LUT",$t.minFilter=Tt,$t.magFilter=Tt,$t.wrapS=hn,$t.wrapT=hn,$t.generateMipmaps=!1,$t.needsUpdate=!0),$t}class $p{constructor(e={}){const{canvas:t=cc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:m=!1,reversedDepthBuffer:u=!1,outputBufferType:g=Ft}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const E=g,f=new Set([aa,sa,ra]),h=new Set([Ft,nn,bi,Ai,na,ia]),M=new Uint32Array(4),y=new Int32Array(4),T=new F;let D=null,b=null;const P=[],_=[];let A=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=en,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let w=!1,O=null;this._outputColorSpace=zt;let q=0,W=0,I=null,G=-1,V=null;const J=new ht,ne=new ht;let ce=null;const ve=new Ve(0);let Ee=0,We=t.width,Qe=t.height,Ne=1,Z=null,he=null;const se=new ht(0,0,We,Qe),we=new ht(0,0,We,Qe);let Le=!1;const Ce=new da;let ot=!1,He=!1;const et=new ct,nt=new F,ze=new ht,Me={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ue=!1;function Re(){return I===null?Ne:1}let R=n;function Xe(x,U){return t.getContext(x,U)}try{const x={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:d,failIfMajorPerformanceCaveat:m};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ea}`),t.addEventListener("webglcontextlost",j,!1),t.addEventListener("webglcontextrestored",ye,!1),t.addEventListener("webglcontextcreationerror",Oe,!1),R===null){const U="webgl2";if(R=Xe(U,x),R===null)throw Xe(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw je("WebGLRenderer: "+x.message),x}let Q,be,ee,Ze,S,p,N,X,$,re,oe,k,K,ue,me,ie,te,De,Ie,Je,C,ae,Y;function ge(){Q=new Zf(R),Q.init(),C=new Gp(R,Q),be=new Vf(R,Q,e,C),ee=new Bp(R,Q),be.reversedDepthBuffer&&u&&ee.buffers.depth.setReversed(!0),Ze=new Jf(R),S=new Tp,p=new zp(R,Q,ee,S,be,C,Ze),N=new Kf(L),X=new tu(R),ae=new zf(R,X),$=new $f(R,X,Ze,ae),re=new ed(R,$,X,ae,Ze),De=new Qf(R,be,p),me=new Hf(S),oe=new yp(L,N,Q,be,ae,me),k=new qp(L,S),K=new Ap,ue=new Lp(Q),te=new Bf(L,N,ee,re,v,c),ie=new Op(L,re,be),Y=new Yp(R,Ze,be,ee),Ie=new Gf(R,Q,Ze),Je=new jf(R,Q,Ze),Ze.programs=oe.programs,L.capabilities=be,L.extensions=Q,L.properties=S,L.renderLists=K,L.shadowMap=ie,L.state=ee,L.info=Ze}ge(),E!==Ft&&(A=new nd(E,t.width,t.height,r,s));const le=new Wp(L,R);this.xr=le,this.getContext=function(){return R},this.getContextAttributes=function(){return R.getContextAttributes()},this.forceContextLoss=function(){const x=Q.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=Q.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return Ne},this.setPixelRatio=function(x){x!==void 0&&(Ne=x,this.setSize(We,Qe,!1))},this.getSize=function(x){return x.set(We,Qe)},this.setSize=function(x,U,H=!0){if(le.isPresenting){Pe("WebGLRenderer: Can't change size while VR device is presenting.");return}We=x,Qe=U,t.width=Math.floor(x*Ne),t.height=Math.floor(U*Ne),H===!0&&(t.style.width=x+"px",t.style.height=U+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,x,U)},this.getDrawingBufferSize=function(x){return x.set(We*Ne,Qe*Ne).floor()},this.setDrawingBufferSize=function(x,U,H){We=x,Qe=U,Ne=H,t.width=Math.floor(x*H),t.height=Math.floor(U*H),this.setViewport(0,0,x,U)},this.setEffects=function(x){if(E===Ft){je("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let U=0;U<x.length;U++)if(x[U].isOutputPass===!0){Pe("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy(J)},this.getViewport=function(x){return x.copy(se)},this.setViewport=function(x,U,H,B){x.isVector4?se.set(x.x,x.y,x.z,x.w):se.set(x,U,H,B),ee.viewport(J.copy(se).multiplyScalar(Ne).round())},this.getScissor=function(x){return x.copy(we)},this.setScissor=function(x,U,H,B){x.isVector4?we.set(x.x,x.y,x.z,x.w):we.set(x,U,H,B),ee.scissor(ne.copy(we).multiplyScalar(Ne).round())},this.getScissorTest=function(){return Le},this.setScissorTest=function(x){ee.setScissorTest(Le=x)},this.setOpaqueSort=function(x){Z=x},this.setTransparentSort=function(x){he=x},this.getClearColor=function(x){return x.copy(te.getClearColor())},this.setClearColor=function(){te.setClearColor(...arguments)},this.getClearAlpha=function(){return te.getClearAlpha()},this.setClearAlpha=function(){te.setClearAlpha(...arguments)},this.clear=function(x=!0,U=!0,H=!0){let B=0;if(x){let z=!1;if(I!==null){const pe=I.texture.format;z=f.has(pe)}if(z){const pe=I.texture.type,xe=h.has(pe),de=te.getClearColor(),Se=te.getClearAlpha(),Te=de.r,Be=de.g,ke=de.b;xe?(M[0]=Te,M[1]=Be,M[2]=ke,M[3]=Se,R.clearBufferuiv(R.COLOR,0,M)):(y[0]=Te,y[1]=Be,y[2]=ke,y[3]=Se,R.clearBufferiv(R.COLOR,0,y))}else B|=R.COLOR_BUFFER_BIT}U&&(B|=R.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),H&&(B|=R.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&R.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(x){x.setRenderer(this),O=x},this.dispose=function(){t.removeEventListener("webglcontextlost",j,!1),t.removeEventListener("webglcontextrestored",ye,!1),t.removeEventListener("webglcontextcreationerror",Oe,!1),te.dispose(),K.dispose(),ue.dispose(),S.dispose(),N.dispose(),re.dispose(),ae.dispose(),Y.dispose(),oe.dispose(),le.dispose(),le.removeEventListener("sessionstart",Ea),le.removeEventListener("sessionend",ya),wn.stop()};function j(x){x.preventDefault(),Ba("WebGLRenderer: Context Lost."),w=!0}function ye(){Ba("WebGLRenderer: Context Restored."),w=!1;const x=Ze.autoReset,U=ie.enabled,H=ie.autoUpdate,B=ie.needsUpdate,z=ie.type;ge(),Ze.autoReset=x,ie.enabled=U,ie.autoUpdate=H,ie.needsUpdate=B,ie.type=z}function Oe(x){je("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function ft(x){const U=x.target;U.removeEventListener("dispose",ft),it(U)}function it(x){rn(x),S.remove(x)}function rn(x){const U=S.get(x).programs;U!==void 0&&(U.forEach(function(H){oe.releaseProgram(H)}),x.isShaderMaterial&&oe.releaseShaderCache(x))}this.renderBufferDirect=function(x,U,H,B,z,pe){U===null&&(U=Me);const xe=z.isMesh&&z.matrixWorld.determinant()<0,de=yl(x,U,H,B,z);ee.setMaterial(B,xe);let Se=H.index,Te=1;if(B.wireframe===!0){if(Se=$.getWireframeAttribute(H),Se===void 0)return;Te=2}const Be=H.drawRange,ke=H.attributes.position;let Ae=Be.start*Te,rt=(Be.start+Be.count)*Te;pe!==null&&(Ae=Math.max(Ae,pe.start*Te),rt=Math.min(rt,(pe.start+pe.count)*Te)),Se!==null?(Ae=Math.max(Ae,0),rt=Math.min(rt,Se.count)):ke!=null&&(Ae=Math.max(Ae,0),rt=Math.min(rt,ke.count));const dt=rt-Ae;if(dt<0||dt===1/0)return;ae.setup(z,B,de,H,Se);let ut,st=Ie;if(Se!==null&&(ut=X.get(Se),st=Je,st.setIndex(ut)),z.isMesh)B.wireframe===!0?(ee.setLineWidth(B.wireframeLinewidth*Re()),st.setMode(R.LINES)):st.setMode(R.TRIANGLES);else if(z.isLine){let St=B.linewidth;St===void 0&&(St=1),ee.setLineWidth(St*Re()),z.isLineSegments?st.setMode(R.LINES):z.isLineLoop?st.setMode(R.LINE_LOOP):st.setMode(R.LINE_STRIP)}else z.isPoints?st.setMode(R.POINTS):z.isSprite&&st.setMode(R.TRIANGLES);if(z.isBatchedMesh)if(Q.get("WEBGL_multi_draw"))st.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const St=z._multiDrawStarts,_e=z._multiDrawCounts,Lt=z._multiDrawCount,$e=Se?X.get(Se).bytesPerElement:1,Ot=S.get(B).currentProgram.getUniforms();for(let Kt=0;Kt<Lt;Kt++)Ot.setValue(R,"_gl_DrawID",Kt),st.render(St[Kt]/$e,_e[Kt])}else if(z.isInstancedMesh)st.renderInstances(Ae,dt,z.count);else if(H.isInstancedBufferGeometry){const St=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,_e=Math.min(H.instanceCount,St);st.renderInstances(Ae,dt,_e)}else st.render(Ae,dt)};function Yt(x,U,H){x.transparent===!0&&x.side===un&&x.forceSinglePass===!1?(x.side=Dt,x.needsUpdate=!0,Ii(x,U,H),x.side=Rn,x.needsUpdate=!0,Ii(x,U,H),x.side=un):Ii(x,U,H)}this.compile=function(x,U,H=null){H===null&&(H=x),b=ue.get(H),b.init(U),_.push(b),H.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),x!==H&&x.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(b.pushLight(z),z.castShadow&&b.pushShadow(z))}),b.setupLights();const B=new Set;return x.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const pe=z.material;if(pe)if(Array.isArray(pe))for(let xe=0;xe<pe.length;xe++){const de=pe[xe];Yt(de,H,z),B.add(de)}else Yt(pe,H,z),B.add(pe)}),b=_.pop(),B},this.compileAsync=function(x,U,H=null){const B=this.compile(x,U,H);return new Promise(z=>{function pe(){if(B.forEach(function(xe){S.get(xe).currentProgram.isReady()&&B.delete(xe)}),B.size===0){z(x);return}setTimeout(pe,10)}Q.get("KHR_parallel_shader_compile")!==null?pe():setTimeout(pe,10)})};let br=null;function Sl(x){br&&br(x)}function Ea(){wn.stop()}function ya(){wn.start()}const wn=new dl;wn.setAnimationLoop(Sl),typeof self<"u"&&wn.setContext(self),this.setAnimationLoop=function(x){br=x,le.setAnimationLoop(x),x===null?wn.stop():wn.start()},le.addEventListener("sessionstart",Ea),le.addEventListener("sessionend",ya),this.render=function(x,U){if(U!==void 0&&U.isCamera!==!0){je("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;O!==null&&O.renderStart(x,U);const H=le.enabled===!0&&le.isPresenting===!0,B=A!==null&&(I===null||H)&&A.begin(L,I);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),le.enabled===!0&&le.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(le.cameraAutoUpdate===!0&&le.updateCamera(U),U=le.getCamera()),x.isScene===!0&&x.onBeforeRender(L,x,U,I),b=ue.get(x,_.length),b.init(U),b.state.textureUnits=p.getTextureUnits(),_.push(b),et.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),Ce.setFromProjectionMatrix(et,Qt,U.reversedDepth),He=this.localClippingEnabled,ot=me.init(this.clippingPlanes,He),D=K.get(x,P.length),D.init(),P.push(D),le.enabled===!0&&le.isPresenting===!0){const xe=L.xr.getDepthSensingMesh();xe!==null&&Ar(xe,U,-1/0,L.sortObjects)}Ar(x,U,0,L.sortObjects),D.finish(),L.sortObjects===!0&&D.sort(Z,he),Ue=le.enabled===!1||le.isPresenting===!1||le.hasDepthSensing()===!1,Ue&&te.addToRenderList(D,x),this.info.render.frame++,ot===!0&&me.beginShadows();const z=b.state.shadowsArray;if(ie.render(z,x,U),ot===!0&&me.endShadows(),this.info.autoReset===!0&&this.info.reset(),(B&&A.hasRenderPass())===!1){const xe=D.opaque,de=D.transmissive;if(b.setupLights(),U.isArrayCamera){const Se=U.cameras;if(de.length>0)for(let Te=0,Be=Se.length;Te<Be;Te++){const ke=Se[Te];ba(xe,de,x,ke)}Ue&&te.render(x);for(let Te=0,Be=Se.length;Te<Be;Te++){const ke=Se[Te];Ta(D,x,ke,ke.viewport)}}else de.length>0&&ba(xe,de,x,U),Ue&&te.render(x),Ta(D,x,U)}I!==null&&W===0&&(p.updateMultisampleRenderTarget(I),p.updateRenderTargetMipmap(I)),B&&A.end(L),x.isScene===!0&&x.onAfterRender(L,x,U),ae.resetDefaultState(),G=-1,V=null,_.pop(),_.length>0?(b=_[_.length-1],p.setTextureUnits(b.state.textureUnits),ot===!0&&me.setGlobalState(L.clippingPlanes,b.state.camera)):b=null,P.pop(),P.length>0?D=P[P.length-1]:D=null,O!==null&&O.renderEnd()};function Ar(x,U,H,B){if(x.visible===!1)return;if(x.layers.test(U.layers)){if(x.isGroup)H=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(U);else if(x.isLightProbeGrid)b.pushLightProbeGrid(x);else if(x.isLight)b.pushLight(x),x.castShadow&&b.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||Ce.intersectsSprite(x)){B&&ze.setFromMatrixPosition(x.matrixWorld).applyMatrix4(et);const xe=re.update(x),de=x.material;de.visible&&D.push(x,xe,de,H,ze.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||Ce.intersectsObject(x))){const xe=re.update(x),de=x.material;if(B&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),ze.copy(x.boundingSphere.center)):(xe.boundingSphere===null&&xe.computeBoundingSphere(),ze.copy(xe.boundingSphere.center)),ze.applyMatrix4(x.matrixWorld).applyMatrix4(et)),Array.isArray(de)){const Se=xe.groups;for(let Te=0,Be=Se.length;Te<Be;Te++){const ke=Se[Te],Ae=de[ke.materialIndex];Ae&&Ae.visible&&D.push(x,xe,Ae,H,ze.z,ke)}}else de.visible&&D.push(x,xe,de,H,ze.z,null)}}const pe=x.children;for(let xe=0,de=pe.length;xe<de;xe++)Ar(pe[xe],U,H,B)}function Ta(x,U,H,B){const{opaque:z,transmissive:pe,transparent:xe}=x;b.setupLightsView(H),ot===!0&&me.setGlobalState(L.clippingPlanes,H),B&&ee.viewport(J.copy(B)),z.length>0&&Ui(z,U,H),pe.length>0&&Ui(pe,U,H),xe.length>0&&Ui(xe,U,H),ee.buffers.depth.setTest(!0),ee.buffers.depth.setMask(!0),ee.buffers.color.setMask(!0),ee.setPolygonOffset(!1)}function ba(x,U,H,B){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[B.id]===void 0){const Ae=Q.has("EXT_color_buffer_half_float")||Q.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[B.id]=new tn(1,1,{generateMipmaps:!0,type:Ae?pn:Ft,minFilter:Fn,samples:Math.max(4,be.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:qe.workingColorSpace})}const pe=b.state.transmissionRenderTarget[B.id],xe=B.viewport||J;pe.setSize(xe.z*L.transmissionResolutionScale,xe.w*L.transmissionResolutionScale);const de=L.getRenderTarget(),Se=L.getActiveCubeFace(),Te=L.getActiveMipmapLevel();L.setRenderTarget(pe),L.getClearColor(ve),Ee=L.getClearAlpha(),Ee<1&&L.setClearColor(16777215,.5),L.clear(),Ue&&te.render(H);const Be=L.toneMapping;L.toneMapping=en;const ke=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),b.setupLightsView(B),ot===!0&&me.setGlobalState(L.clippingPlanes,B),Ui(x,H,B),p.updateMultisampleRenderTarget(pe),p.updateRenderTargetMipmap(pe),Q.has("WEBGL_multisampled_render_to_texture")===!1){let Ae=!1;for(let rt=0,dt=U.length;rt<dt;rt++){const ut=U[rt],{object:st,geometry:St,material:_e,group:Lt}=ut;if(_e.side===un&&st.layers.test(B.layers)){const $e=_e.side;_e.side=Dt,_e.needsUpdate=!0,Aa(st,H,B,St,_e,Lt),_e.side=$e,_e.needsUpdate=!0,Ae=!0}}Ae===!0&&(p.updateMultisampleRenderTarget(pe),p.updateRenderTargetMipmap(pe))}L.setRenderTarget(de,Se,Te),L.setClearColor(ve,Ee),ke!==void 0&&(B.viewport=ke),L.toneMapping=Be}function Ui(x,U,H){const B=U.isScene===!0?U.overrideMaterial:null;for(let z=0,pe=x.length;z<pe;z++){const xe=x[z],{object:de,geometry:Se,group:Te}=xe;let Be=xe.material;Be.allowOverride===!0&&B!==null&&(Be=B),de.layers.test(H.layers)&&Aa(de,U,H,Se,Be,Te)}}function Aa(x,U,H,B,z,pe){x.onBeforeRender(L,U,H,B,z,pe),x.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),z.onBeforeRender(L,U,H,B,x,pe),z.transparent===!0&&z.side===un&&z.forceSinglePass===!1?(z.side=Dt,z.needsUpdate=!0,L.renderBufferDirect(H,U,B,z,x,pe),z.side=Rn,z.needsUpdate=!0,L.renderBufferDirect(H,U,B,z,x,pe),z.side=un):L.renderBufferDirect(H,U,B,z,x,pe),x.onAfterRender(L,U,H,B,z,pe)}function Ii(x,U,H){U.isScene!==!0&&(U=Me);const B=S.get(x),z=b.state.lights,pe=b.state.shadowsArray,xe=z.state.version,de=oe.getParameters(x,z.state,pe,U,H,b.state.lightProbeGridArray),Se=oe.getProgramCacheKey(de);let Te=B.programs;B.environment=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?U.environment:null,B.fog=U.fog;const Be=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap;B.envMap=N.get(x.envMap||B.environment,Be),B.envMapRotation=B.environment!==null&&x.envMap===null?U.environmentRotation:x.envMapRotation,Te===void 0&&(x.addEventListener("dispose",ft),Te=new Map,B.programs=Te);let ke=Te.get(Se);if(ke!==void 0){if(B.currentProgram===ke&&B.lightsStateVersion===xe)return wa(x,de),ke}else de.uniforms=oe.getUniforms(x),O!==null&&x.isNodeMaterial&&O.build(x,H,de),x.onBeforeCompile(de,L),ke=oe.acquireProgram(de,Se),Te.set(Se,ke),B.uniforms=de.uniforms;const Ae=B.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Ae.clippingPlanes=me.uniform),wa(x,de),B.needsLights=bl(x),B.lightsStateVersion=xe,B.needsLights&&(Ae.ambientLightColor.value=z.state.ambient,Ae.lightProbe.value=z.state.probe,Ae.directionalLights.value=z.state.directional,Ae.directionalLightShadows.value=z.state.directionalShadow,Ae.spotLights.value=z.state.spot,Ae.spotLightShadows.value=z.state.spotShadow,Ae.rectAreaLights.value=z.state.rectArea,Ae.ltc_1.value=z.state.rectAreaLTC1,Ae.ltc_2.value=z.state.rectAreaLTC2,Ae.pointLights.value=z.state.point,Ae.pointLightShadows.value=z.state.pointShadow,Ae.hemisphereLights.value=z.state.hemi,Ae.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Ae.spotLightMatrix.value=z.state.spotLightMatrix,Ae.spotLightMap.value=z.state.spotLightMap,Ae.pointShadowMatrix.value=z.state.pointShadowMatrix),B.lightProbeGrid=b.state.lightProbeGridArray.length>0,B.currentProgram=ke,B.uniformsList=null,ke}function Ra(x){if(x.uniformsList===null){const U=x.currentProgram.getUniforms();x.uniformsList=fr.seqWithValue(U.seq,x.uniforms)}return x.uniformsList}function wa(x,U){const H=S.get(x);H.outputColorSpace=U.outputColorSpace,H.batching=U.batching,H.batchingColor=U.batchingColor,H.instancing=U.instancing,H.instancingColor=U.instancingColor,H.instancingMorph=U.instancingMorph,H.skinning=U.skinning,H.morphTargets=U.morphTargets,H.morphNormals=U.morphNormals,H.morphColors=U.morphColors,H.morphTargetsCount=U.morphTargetsCount,H.numClippingPlanes=U.numClippingPlanes,H.numIntersection=U.numClipIntersection,H.vertexAlphas=U.vertexAlphas,H.vertexTangents=U.vertexTangents,H.toneMapping=U.toneMapping}function El(x,U){if(x.length===0)return null;if(x.length===1)return x[0].texture!==null?x[0]:null;T.setFromMatrixPosition(U.matrixWorld);for(let H=0,B=x.length;H<B;H++){const z=x[H];if(z.texture!==null&&z.boundingBox.containsPoint(T))return z}return null}function yl(x,U,H,B,z){U.isScene!==!0&&(U=Me),p.resetTextureUnits();const pe=U.fog,xe=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?U.environment:null,de=I===null?L.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:qe.workingColorSpace,Se=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Te=N.get(B.envMap||xe,Se),Be=B.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,ke=!!H.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),Ae=!!H.morphAttributes.position,rt=!!H.morphAttributes.normal,dt=!!H.morphAttributes.color;let ut=en;B.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(ut=L.toneMapping);const st=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,St=st!==void 0?st.length:0,_e=S.get(B),Lt=b.state.lights;if(ot===!0&&(He===!0||x!==V)){const lt=x===V&&B.id===G;me.setState(B,x,lt)}let $e=!1;B.version===_e.__version?(_e.needsLights&&_e.lightsStateVersion!==Lt.state.version||_e.outputColorSpace!==de||z.isBatchedMesh&&_e.batching===!1||!z.isBatchedMesh&&_e.batching===!0||z.isBatchedMesh&&_e.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&_e.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&_e.instancing===!1||!z.isInstancedMesh&&_e.instancing===!0||z.isSkinnedMesh&&_e.skinning===!1||!z.isSkinnedMesh&&_e.skinning===!0||z.isInstancedMesh&&_e.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&_e.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&_e.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&_e.instancingMorph===!1&&z.morphTexture!==null||_e.envMap!==Te||B.fog===!0&&_e.fog!==pe||_e.numClippingPlanes!==void 0&&(_e.numClippingPlanes!==me.numPlanes||_e.numIntersection!==me.numIntersection)||_e.vertexAlphas!==Be||_e.vertexTangents!==ke||_e.morphTargets!==Ae||_e.morphNormals!==rt||_e.morphColors!==dt||_e.toneMapping!==ut||_e.morphTargetsCount!==St||!!_e.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&($e=!0):($e=!0,_e.__version=B.version);let Ot=_e.currentProgram;$e===!0&&(Ot=Ii(B,U,z),O&&B.isNodeMaterial&&O.onUpdateProgram(B,Ot,_e));let Kt=!1,gn=!1,Hn=!1;const at=Ot.getUniforms(),pt=_e.uniforms;if(ee.useProgram(Ot.program)&&(Kt=!0,gn=!0,Hn=!0),B.id!==G&&(G=B.id,gn=!0),_e.needsLights){const lt=El(b.state.lightProbeGridArray,z);_e.lightProbeGrid!==lt&&(_e.lightProbeGrid=lt,gn=!0)}if(Kt||V!==x){ee.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),at.setValue(R,"projectionMatrix",x.projectionMatrix),at.setValue(R,"viewMatrix",x.matrixWorldInverse);const xn=at.map.cameraPosition;xn!==void 0&&xn.setValue(R,nt.setFromMatrixPosition(x.matrixWorld)),be.logarithmicDepthBuffer&&at.setValue(R,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&at.setValue(R,"isOrthographic",x.isOrthographicCamera===!0),V!==x&&(V=x,gn=!0,Hn=!0)}if(_e.needsLights&&(Lt.state.directionalShadowMap.length>0&&at.setValue(R,"directionalShadowMap",Lt.state.directionalShadowMap,p),Lt.state.spotShadowMap.length>0&&at.setValue(R,"spotShadowMap",Lt.state.spotShadowMap,p),Lt.state.pointShadowMap.length>0&&at.setValue(R,"pointShadowMap",Lt.state.pointShadowMap,p)),z.isSkinnedMesh){at.setOptional(R,z,"bindMatrix"),at.setOptional(R,z,"bindMatrixInverse");const lt=z.skeleton;lt&&(lt.boneTexture===null&&lt.computeBoneTexture(),at.setValue(R,"boneTexture",lt.boneTexture,p))}z.isBatchedMesh&&(at.setOptional(R,z,"batchingTexture"),at.setValue(R,"batchingTexture",z._matricesTexture,p),at.setOptional(R,z,"batchingIdTexture"),at.setValue(R,"batchingIdTexture",z._indirectTexture,p),at.setOptional(R,z,"batchingColorTexture"),z._colorsTexture!==null&&at.setValue(R,"batchingColorTexture",z._colorsTexture,p));const _n=H.morphAttributes;if((_n.position!==void 0||_n.normal!==void 0||_n.color!==void 0)&&De.update(z,H,Ot),(gn||_e.receiveShadow!==z.receiveShadow)&&(_e.receiveShadow=z.receiveShadow,at.setValue(R,"receiveShadow",z.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&U.environment!==null&&(pt.envMapIntensity.value=U.environmentIntensity),pt.dfgLUT!==void 0&&(pt.dfgLUT.value=Zp()),gn){if(at.setValue(R,"toneMappingExposure",L.toneMappingExposure),_e.needsLights&&Tl(pt,Hn),pe&&B.fog===!0&&k.refreshFogUniforms(pt,pe),k.refreshMaterialUniforms(pt,B,Ne,Qe,b.state.transmissionRenderTarget[x.id]),_e.needsLights&&_e.lightProbeGrid){const lt=_e.lightProbeGrid;pt.probesSH.value=lt.texture,pt.probesMin.value.copy(lt.boundingBox.min),pt.probesMax.value.copy(lt.boundingBox.max),pt.probesResolution.value.copy(lt.resolution)}fr.upload(R,Ra(_e),pt,p)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(fr.upload(R,Ra(_e),pt,p),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&at.setValue(R,"center",z.center),at.setValue(R,"modelViewMatrix",z.modelViewMatrix),at.setValue(R,"normalMatrix",z.normalMatrix),at.setValue(R,"modelMatrix",z.matrixWorld),B.uniformsGroups!==void 0){const lt=B.uniformsGroups;for(let xn=0,kn=lt.length;xn<kn;xn++){const Ca=lt[xn];Y.update(Ca,Ot),Y.bind(Ca,Ot)}}return Ot}function Tl(x,U){x.ambientLightColor.needsUpdate=U,x.lightProbe.needsUpdate=U,x.directionalLights.needsUpdate=U,x.directionalLightShadows.needsUpdate=U,x.pointLights.needsUpdate=U,x.pointLightShadows.needsUpdate=U,x.spotLights.needsUpdate=U,x.spotLightShadows.needsUpdate=U,x.rectAreaLights.needsUpdate=U,x.hemisphereLights.needsUpdate=U}function bl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return q},this.getActiveMipmapLevel=function(){return W},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(x,U,H){const B=S.get(x);B.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),S.get(x.texture).__webglTexture=U,S.get(x.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:H,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,U){const H=S.get(x);H.__webglFramebuffer=U,H.__useDefaultFramebuffer=U===void 0};const Al=R.createFramebuffer();this.setRenderTarget=function(x,U=0,H=0){I=x,q=U,W=H;let B=null,z=!1,pe=!1;if(x){const de=S.get(x);if(de.__useDefaultFramebuffer!==void 0){ee.bindFramebuffer(R.FRAMEBUFFER,de.__webglFramebuffer),J.copy(x.viewport),ne.copy(x.scissor),ce=x.scissorTest,ee.viewport(J),ee.scissor(ne),ee.setScissorTest(ce),G=-1;return}else if(de.__webglFramebuffer===void 0)p.setupRenderTarget(x);else if(de.__hasExternalTextures)p.rebindTextures(x,S.get(x.texture).__webglTexture,S.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const Be=x.depthTexture;if(de.__boundDepthTexture!==Be){if(Be!==null&&S.has(Be)&&(x.width!==Be.image.width||x.height!==Be.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");p.setupDepthRenderbuffer(x)}}const Se=x.texture;(Se.isData3DTexture||Se.isDataArrayTexture||Se.isCompressedArrayTexture)&&(pe=!0);const Te=S.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Te[U])?B=Te[U][H]:B=Te[U],z=!0):x.samples>0&&p.useMultisampledRTT(x)===!1?B=S.get(x).__webglMultisampledFramebuffer:Array.isArray(Te)?B=Te[H]:B=Te,J.copy(x.viewport),ne.copy(x.scissor),ce=x.scissorTest}else J.copy(se).multiplyScalar(Ne).floor(),ne.copy(we).multiplyScalar(Ne).floor(),ce=Le;if(H!==0&&(B=Al),ee.bindFramebuffer(R.FRAMEBUFFER,B)&&ee.drawBuffers(x,B),ee.viewport(J),ee.scissor(ne),ee.setScissorTest(ce),z){const de=S.get(x.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_CUBE_MAP_POSITIVE_X+U,de.__webglTexture,H)}else if(pe){const de=U;for(let Se=0;Se<x.textures.length;Se++){const Te=S.get(x.textures[Se]);R.framebufferTextureLayer(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0+Se,Te.__webglTexture,H,de)}}else if(x!==null&&H!==0){const de=S.get(x.texture);R.framebufferTexture2D(R.FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,de.__webglTexture,H)}G=-1},this.readRenderTargetPixels=function(x,U,H,B,z,pe,xe,de=0){if(!(x&&x.isWebGLRenderTarget)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Se=S.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&xe!==void 0&&(Se=Se[xe]),Se){ee.bindFramebuffer(R.FRAMEBUFFER,Se);try{const Te=x.textures[de],Be=Te.format,ke=Te.type;if(x.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+de),!be.textureFormatReadable(Be)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!be.textureTypeReadable(ke)){je("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=x.width-B&&H>=0&&H<=x.height-z&&R.readPixels(U,H,B,z,C.convert(Be),C.convert(ke),pe)}finally{const Te=I!==null?S.get(I).__webglFramebuffer:null;ee.bindFramebuffer(R.FRAMEBUFFER,Te)}}},this.readRenderTargetPixelsAsync=async function(x,U,H,B,z,pe,xe,de=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Se=S.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&xe!==void 0&&(Se=Se[xe]),Se)if(U>=0&&U<=x.width-B&&H>=0&&H<=x.height-z){ee.bindFramebuffer(R.FRAMEBUFFER,Se);const Te=x.textures[de],Be=Te.format,ke=Te.type;if(x.textures.length>1&&R.readBuffer(R.COLOR_ATTACHMENT0+de),!be.textureFormatReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!be.textureTypeReadable(ke))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ae=R.createBuffer();R.bindBuffer(R.PIXEL_PACK_BUFFER,Ae),R.bufferData(R.PIXEL_PACK_BUFFER,pe.byteLength,R.STREAM_READ),R.readPixels(U,H,B,z,C.convert(Be),C.convert(ke),0);const rt=I!==null?S.get(I).__webglFramebuffer:null;ee.bindFramebuffer(R.FRAMEBUFFER,rt);const dt=R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE,0);return R.flush(),await uc(R,dt,4),R.bindBuffer(R.PIXEL_PACK_BUFFER,Ae),R.getBufferSubData(R.PIXEL_PACK_BUFFER,0,pe),R.deleteBuffer(Ae),R.deleteSync(dt),pe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,U=null,H=0){const B=Math.pow(2,-H),z=Math.floor(x.image.width*B),pe=Math.floor(x.image.height*B),xe=U!==null?U.x:0,de=U!==null?U.y:0;p.setTexture2D(x,0),R.copyTexSubImage2D(R.TEXTURE_2D,H,0,0,xe,de,z,pe),ee.unbindTexture()};const Rl=R.createFramebuffer(),wl=R.createFramebuffer();this.copyTextureToTexture=function(x,U,H=null,B=null,z=0,pe=0){let xe,de,Se,Te,Be,ke,Ae,rt,dt;const ut=x.isCompressedTexture?x.mipmaps[pe]:x.image;if(H!==null)xe=H.max.x-H.min.x,de=H.max.y-H.min.y,Se=H.isBox3?H.max.z-H.min.z:1,Te=H.min.x,Be=H.min.y,ke=H.isBox3?H.min.z:0;else{const pt=Math.pow(2,-z);xe=Math.floor(ut.width*pt),de=Math.floor(ut.height*pt),x.isDataArrayTexture?Se=ut.depth:x.isData3DTexture?Se=Math.floor(ut.depth*pt):Se=1,Te=0,Be=0,ke=0}B!==null?(Ae=B.x,rt=B.y,dt=B.z):(Ae=0,rt=0,dt=0);const st=C.convert(U.format),St=C.convert(U.type);let _e;U.isData3DTexture?(p.setTexture3D(U,0),_e=R.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(p.setTexture2DArray(U,0),_e=R.TEXTURE_2D_ARRAY):(p.setTexture2D(U,0),_e=R.TEXTURE_2D),ee.activeTexture(R.TEXTURE0),ee.pixelStorei(R.UNPACK_FLIP_Y_WEBGL,U.flipY),ee.pixelStorei(R.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),ee.pixelStorei(R.UNPACK_ALIGNMENT,U.unpackAlignment);const Lt=ee.getParameter(R.UNPACK_ROW_LENGTH),$e=ee.getParameter(R.UNPACK_IMAGE_HEIGHT),Ot=ee.getParameter(R.UNPACK_SKIP_PIXELS),Kt=ee.getParameter(R.UNPACK_SKIP_ROWS),gn=ee.getParameter(R.UNPACK_SKIP_IMAGES);ee.pixelStorei(R.UNPACK_ROW_LENGTH,ut.width),ee.pixelStorei(R.UNPACK_IMAGE_HEIGHT,ut.height),ee.pixelStorei(R.UNPACK_SKIP_PIXELS,Te),ee.pixelStorei(R.UNPACK_SKIP_ROWS,Be),ee.pixelStorei(R.UNPACK_SKIP_IMAGES,ke);const Hn=x.isDataArrayTexture||x.isData3DTexture,at=U.isDataArrayTexture||U.isData3DTexture;if(x.isDepthTexture){const pt=S.get(x),_n=S.get(U),lt=S.get(pt.__renderTarget),xn=S.get(_n.__renderTarget);ee.bindFramebuffer(R.READ_FRAMEBUFFER,lt.__webglFramebuffer),ee.bindFramebuffer(R.DRAW_FRAMEBUFFER,xn.__webglFramebuffer);for(let kn=0;kn<Se;kn++)Hn&&(R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,S.get(x).__webglTexture,z,ke+kn),R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,S.get(U).__webglTexture,pe,dt+kn)),R.blitFramebuffer(Te,Be,xe,de,Ae,rt,xe,de,R.DEPTH_BUFFER_BIT,R.NEAREST);ee.bindFramebuffer(R.READ_FRAMEBUFFER,null),ee.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else if(z!==0||x.isRenderTargetTexture||S.has(x)){const pt=S.get(x),_n=S.get(U);ee.bindFramebuffer(R.READ_FRAMEBUFFER,Rl),ee.bindFramebuffer(R.DRAW_FRAMEBUFFER,wl);for(let lt=0;lt<Se;lt++)Hn?R.framebufferTextureLayer(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,pt.__webglTexture,z,ke+lt):R.framebufferTexture2D(R.READ_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,pt.__webglTexture,z),at?R.framebufferTextureLayer(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,_n.__webglTexture,pe,dt+lt):R.framebufferTexture2D(R.DRAW_FRAMEBUFFER,R.COLOR_ATTACHMENT0,R.TEXTURE_2D,_n.__webglTexture,pe),z!==0?R.blitFramebuffer(Te,Be,xe,de,Ae,rt,xe,de,R.COLOR_BUFFER_BIT,R.NEAREST):at?R.copyTexSubImage3D(_e,pe,Ae,rt,dt+lt,Te,Be,xe,de):R.copyTexSubImage2D(_e,pe,Ae,rt,Te,Be,xe,de);ee.bindFramebuffer(R.READ_FRAMEBUFFER,null),ee.bindFramebuffer(R.DRAW_FRAMEBUFFER,null)}else at?x.isDataTexture||x.isData3DTexture?R.texSubImage3D(_e,pe,Ae,rt,dt,xe,de,Se,st,St,ut.data):U.isCompressedArrayTexture?R.compressedTexSubImage3D(_e,pe,Ae,rt,dt,xe,de,Se,st,ut.data):R.texSubImage3D(_e,pe,Ae,rt,dt,xe,de,Se,st,St,ut):x.isDataTexture?R.texSubImage2D(R.TEXTURE_2D,pe,Ae,rt,xe,de,st,St,ut.data):x.isCompressedTexture?R.compressedTexSubImage2D(R.TEXTURE_2D,pe,Ae,rt,ut.width,ut.height,st,ut.data):R.texSubImage2D(R.TEXTURE_2D,pe,Ae,rt,xe,de,st,St,ut);ee.pixelStorei(R.UNPACK_ROW_LENGTH,Lt),ee.pixelStorei(R.UNPACK_IMAGE_HEIGHT,$e),ee.pixelStorei(R.UNPACK_SKIP_PIXELS,Ot),ee.pixelStorei(R.UNPACK_SKIP_ROWS,Kt),ee.pixelStorei(R.UNPACK_SKIP_IMAGES,gn),pe===0&&U.generateMipmaps&&R.generateMipmap(_e),ee.unbindTexture()},this.initRenderTarget=function(x){S.get(x).__webglFramebuffer===void 0&&p.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?p.setTextureCube(x,0):x.isData3DTexture?p.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?p.setTexture2DArray(x,0):p.setTexture2D(x,0),ee.unbindTexture()},this.resetState=function(){q=0,W=0,I=null,ee.reset(),ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Qt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=qe._getDrawingBufferColorSpace(e),t.unpackColorSpace=qe._getUnpackColorSpace()}}function Jp({mode:i="stellar",activeTab:e}){const t=di.useRef(null),n=di.useRef(null),r=di.useRef("");return di.useEffect(()=>{e&&n.current&&(r.current&&r.current!==e&&(n.current.uProgress.value=0),r.current=e)},[e]),di.useEffect(()=>{if(!t.current)return;const s=t.current;let a=328968;i==="stellar"?a=657935:i==="ink"?a=66054:i==="forest"?a=395269:i==="constellation"&&(a=197640);const o=new Ac;o.fog=new ua(a,.015);const c=new Nt(60,s.clientWidth/s.clientHeight,.1,1e3);c.position.z=35;const l=new $p({antialias:!0,alpha:!0});l.setPixelRatio(Math.min(window.devicePixelRatio,2)),l.setSize(s.clientWidth,s.clientHeight),s.appendChild(l.domElement);const d=Me=>{const Ue=document.createElement("canvas");Ue.width=64,Ue.height=64;const Re=Ue.getContext("2d");if(Re)if(Re.clearRect(0,0,64,64),Me==="ink"){const R=["i","n","k","h","o","m","e","f","x","@","&","{","}","+"],Xe=R[Math.floor(Math.random()*R.length)],Q=R[Math.floor(Math.random()*R.length)],be=Re.createRadialGradient(32,32,0,32,32,32);be.addColorStop(0,"rgba(56, 189, 248, 0.4)"),be.addColorStop(.3,"rgba(99, 102, 241, 0.25)"),be.addColorStop(1,"rgba(0, 0, 0, 0)"),Re.fillStyle=be,Re.beginPath(),Re.arc(32,32,32,0,Math.PI*2),Re.fill(),Re.font="bold 26px 'Courier New', monospace, 'JetBrains Mono'",Re.fillStyle="rgba(255, 255, 255, 0.95)",Re.textAlign="center",Re.textBaseline="middle",Re.fillText(Xe,28,30),Re.font="18px sans-serif",Re.fillStyle="rgba(14, 165, 233, 0.7)",Re.fillText(Q,42,40)}else if(Me==="forest"){const R=Re.createRadialGradient(32,32,0,32,32,32);R.addColorStop(0,"rgba(255, 243, 219, 1.0)"),R.addColorStop(.15,"rgba(245, 158, 11, 0.85)"),R.addColorStop(.45,"rgba(234, 88, 12, 0.4)"),R.addColorStop(1,"rgba(0, 0, 0, 0)"),Re.fillStyle=R,Re.beginPath(),Re.arc(32,32,32,0,Math.PI*2),Re.fill()}else if(Me==="constellation"){const R=Re.createRadialGradient(32,32,0,32,32,32);R.addColorStop(0,"rgba(255, 255, 255, 1.0)"),R.addColorStop(.2,"rgba(16, 185, 129, 0.9)"),R.addColorStop(.5,"rgba(59, 130, 246, 0.35)"),R.addColorStop(1,"rgba(0, 0, 0, 0)"),Re.fillStyle=R,Re.beginPath(),Re.arc(32,32,32,0,Math.PI*2),Re.fill()}else{const R=Re.createRadialGradient(32,32,0,32,32,32);R.addColorStop(0,"rgba(255, 255, 255, 1)"),R.addColorStop(.2,"rgba(168, 85, 247, 0.8)"),R.addColorStop(.6,"rgba(56, 189, 248, 0.2)"),R.addColorStop(1,"rgba(0, 0, 0, 0)"),Re.fillStyle=R,Re.beginPath(),Re.arc(32,32,32,0,Math.PI*2),Re.fill()}return new zc(Ue)},m=i==="constellation"?120:i==="forest"?220:180,u=new wt,g=new Float32Array(m*3),v=new Float32Array(m*3),E=new Float32Array(m),f=[],h=new Ve(440020),M=new Ve(9133302),y=new Ve(15485081),T=new Ve(16096779),D=new Ve(15357964),b=new Ve(1096065),P=new Ve(3900150);for(let Me=0;Me<m;Me++){let Ue=0,Re=0,R=0,Xe=h;if(i==="forest")Ue=(Math.random()-.5)*60,Re=(Math.random()-.5)*50,R=(Math.random()-.5)*35,Xe=Math.random()>.4?T:D,E[Me]=.8+Math.random()*2.2;else if(i==="ink")Ue=(Math.random()-.5)*70,Re=(Math.random()-.5)*45,R=(Math.random()-.5)*20,Xe=Math.random()>.6?M:Math.random()>.3?h:y,E[Me]=1.4+Math.random()*2.5;else if(i==="constellation"){const Q=12+Math.random()*30,be=Math.random()*Math.PI*2,ee=Math.acos(Math.random()*2-1);Ue=Q*Math.sin(ee)*Math.cos(be),Re=Q*Math.sin(ee)*Math.sin(be),R=Q*Math.cos(ee),Xe=Math.random()>.5?b:P,E[Me]=1+Math.random()*1.5}else{const Q=20+Math.random()*40,be=Math.random()*Math.PI*2,ee=Math.acos(Math.random()*2-1);Ue=Q*Math.sin(ee)*Math.cos(be),Re=Q*Math.sin(ee)*Math.sin(be),R=Q*Math.cos(ee),Xe=Math.random()>.65?M:Math.random()>.3?h:y,E[Me]=1.2+Math.random()*1.8}g[Me*3]=Ue,g[Me*3+1]=Re,g[Me*3+2]=R,v[Me*3]=Xe.r,v[Me*3+1]=Xe.g,v[Me*3+2]=Xe.b,f.push({x:(Math.random()-.5)*.04,y:i==="forest"?.05+Math.random()*.08:(Math.random()-.5)*.04,z:(Math.random()-.5)*.02,speedMultiplier:.5+Math.random()*1.2,wiggleFreq:.3+Math.random()*1.2})}u.setAttribute("position",new Pt(g,3)),u.setAttribute("color",new Pt(v,3));const _=new al({size:i==="forest"?2.5:2,map:d(i),vertexColors:!0,transparent:!0,opacity:i==="forest"?.9:.85,blending:dr,depthWrite:!1}),A=new Bc(u,_);o.add(A);const L=new yi;o.add(L);const w=i==="forest"?14251782:i==="constellation"?366185:11032055,O=new fa({color:w,wireframe:!0,transparent:!0,opacity:i==="forest"?.03:i==="ink"?.04:.09}),q=[];(i==="stellar"||i==="ink")&&[16,26,38].forEach((Ue,Re)=>{const R=i==="ink"?new ga(Ue,.1,4,32):new ma(Ue,1),Xe=new Xt(R,O);Xe.rotation.x=Math.random()*Math.PI,Xe.rotation.y=Math.random()*Math.PI,L.add(Xe),q.push(Xe)});let W=null,I,G,V=120;if(i==="constellation"){const Me=new wt;I=new Float32Array(V*2*3),G=new Float32Array(V*2*3),Me.setAttribute("position",new Pt(I,3)),Me.setAttribute("color",new Pt(G,3));const Ue=new sl({vertexColors:!0,transparent:!0,opacity:.35,blending:dr,depthWrite:!1});W=new Oc(Me,Ue),o.add(W)}const J=new $c(16777215,i==="forest"?.25:.15);o.add(J);const ne=i==="forest"?16096779:i==="constellation"?1096065:54015,ce=i==="forest"?15357964:i==="constellation"?2450411:10289407,ve=new uo(ne,1.5,60);ve.position.set(20,15,10),o.add(ve);const Ee=new uo(ce,1.5,60);Ee.position.set(-20,-15,10),o.add(Ee);let We=397869;i==="ink"?We=66052:i==="forest"?We=265734:i==="constellation"&&(We=198680);const Qe={uTime:{value:0},uProgress:{value:1},uResolution:{value:new Ke(s.clientWidth,s.clientHeight)},uInkColor:{value:new Ve(We)}};n.current=Qe;const Ne=new Li(2,2),Z=new qt({vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
      ...
      `,uniforms:Qe,transparent:!0,depthTest:!1,depthWrite:!1}),he=new Xt(Ne,Z);he.renderOrder=999,o.add(he);let se=0,we=0;const Le=Me=>{se=Me.clientX/window.innerWidth*2-1,we=-(Me.clientY/window.innerHeight)*2+1};window.addEventListener("mousemove",Le);const Ce=()=>{if(!t.current)return;const Me=t.current.clientWidth,Ue=t.current.clientHeight;c.aspect=Me/Ue,c.updateProjectionMatrix(),l.setSize(Me,Ue),n.current&&n.current.uResolution.value.set(Me,Ue)},ot=new ResizeObserver(()=>{Ce()});ot.observe(s);let He;const et=new Qc;let nt=performance.now();const ze=()=>{const Me=et.getElapsedTime(),Ue=performance.now(),Re=Math.min((Ue-nt)/1e3,.1);nt=Ue;const R=u.getAttribute("position");if(n.current&&(n.current.uTime.value=Me,n.current.uProgress.value<1&&(n.current.uProgress.value+=Re*.82,n.current.uProgress.value>1&&(n.current.uProgress.value=1))),i==="forest"){for(let Q=0;Q<m;Q++){const be=R.getY(Q),ee=R.getX(Q);R.getZ(Q);const Ze=f[Q],S=be+Ze.y*Ze.speedMultiplier,p=Math.sin(Me*Ze.wiggleFreq+Q)*.05,N=ee+p+Ze.x*.1;S>30?(R.setY(Q,-30),R.setX(Q,(Math.random()-.5)*60)):(R.setY(Q,S),R.setX(Q,N))}R.needsUpdate=!0,A.rotation.y=Me*.01}else if(i==="ink"){for(let Q=0;Q<m;Q++){const be=R.getY(Q),ee=R.getX(Q);R.getZ(Q);const S=.005*f[Q].speedMultiplier,p=Me*S+Q,N=ee+Math.sin(p)*.015,X=be+Math.cos(p)*.015;R.setX(Q,N),R.setY(Q,X)}R.needsUpdate=!0,q.forEach((Q,be)=>{Q.rotation.z=Me*(.015*(be+1)),Q.rotation.y=Me*(.008*(be+1))}),A.rotation.y=Me*.02}else if(i==="constellation"){for(let Q=0;Q<m;Q++){const be=R.getX(Q),ee=R.getY(Q),Ze=R.getZ(Q),S=f[Q];let p=be+S.x*.3,N=ee+S.y*.3,X=Ze+S.z*.3;Math.sqrt(p*p+N*N+X*X)>38&&(S.x=-S.x,S.y=-S.y,S.z=-S.z),R.setX(Q,p),R.setY(Q,N),R.setZ(Q,X)}if(R.needsUpdate=!0,A.rotation.y=Me*.015,A.rotation.x=Me*.005,W&&I&&G){let Q=0;for(let be=0;be<Math.min(m,80)&&!(Q>=V);be++){const ee=R.getX(be),Ze=R.getY(be),S=R.getZ(be);for(let p=be+1;p<Math.min(m,80)&&!(Q>=V);p++){const N=R.getX(p),X=R.getY(p),$=R.getZ(p),re=ee-N,oe=Ze-X,k=S-$,K=Math.sqrt(re*re+oe*oe+k*k);if(K<13.5){const ue=Q*6,me=Q*6+3;I[ue]=ee,I[ue+1]=Ze,I[ue+2]=S,I[me]=N,I[me+1]=X,I[me+2]=$;const ie=1-K/13.5,te=Math.random()>.5?b:P,De=Q*6,Ie=Q*6+3;G[De]=te.r*ie*.8,G[De+1]=te.g*ie*.8,G[De+2]=te.b*ie*.8,G[Ie]=te.r*ie*.8,G[Ie+1]=te.g*ie*.8,G[Ie+2]=te.b*ie*.8,Q++}}}W.geometry.getAttribute("position").needsUpdate=!0,W.geometry.getAttribute("color").needsUpdate=!0,W.geometry.setDrawRange(0,Q*2)}}else{const Q=r.current==="story"?2.5:1;A.rotation.y=Me*.035*Q,A.rotation.x=Me*.012*Q,q.forEach((be,ee)=>{be.rotation.x+=.001*(ee+1)*Q,be.rotation.y+=.002*(ee+2)*Q})}const Xe=r.current==="story"?18:35;c.position.z+=(Xe-c.position.z)*.05,c.position.x+=(se*5-c.position.x)*.05,c.position.y+=(we*5-c.position.y)*.05,c.lookAt(o.position),l.render(o,c),He=requestAnimationFrame(ze)};return ze(),()=>{cancelAnimationFrame(He),window.removeEventListener("mousemove",Le),ot.disconnect(),s.contains(l.domElement)&&s.removeChild(l.domElement),u.dispose(),_.dispose(),O.dispose(),l.dispose(),Ne.dispose(),Z.dispose(),W&&(W.geometry.dispose(),W.material.dispose())}},[i]),Cl.jsx("div",{ref:t,className:"absolute inset-0 w-full h-full pointer-events-none overflow-hidden z-0",id:"3d-scene-container"})}export{Jp as default};
